...
<div
    ...
    <form data-kt-search-element="form" class="w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
        ...
        <!--begin::Icon-->
        {!! theme()->getSvgIcon("icons/duotone/General/Search.svg", "svg-icon-2 svg-icon-lg-1 svg-icon-gray-500 position-absolute top-50 translate-middle-y ms-5") !!}
        <!--end::Icon-->
        ...
        <span class="btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-4" data-kt-search-element="clear">
            {!! theme()->getSvgIcon("icons/duotone/Navigation/Close.svg", "svg-icon-2 svg-icon-lg-1 me-0") !!}
        </span>
        <!--end::Reset-->
    </form>
    <!--end::Form-->
