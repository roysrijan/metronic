		...
		<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
			...
			<div class="d-flex align-items-center mb-2">
				...
				<div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
					...
					title="Quick links"
				>
					{!! theme()->getSvgIcon("icons/duotone/Code/Compiling.svg", "svg-icon-2 svg-icon-lg-1") !!}
				</div>
			...
			<div class="d-flex align-items-center mb-2">
				...
				<div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light"
					...
					data-bs-dismiss="click"
					title="Notifications">
					{!! theme()->getSvgIcon("icons/duotone/Layout/Layout-4-blocks.svg", "svg-icon-2 svg-icon-lg-1") !!}
				</div>
			...
			<div class="d-flex align-items-center mb-3">
				...
				id="kt_activities_toggle">
					{!! theme()->getSvgIcon("icons/duotone/Media/Equalizer.svg", "svg-icon-2 svg-icon-lg-1") !!}
				</div>
				<!--end::drawer toggle-->
			</div>
			<!--end::Activities-->
