<template>
  ...
  >
    <div class="container">
      <div
        class="d-flex align-items-stretch justify-content-between py-3 h-75px"
      >
        <div
          class="d-flex align-items-center d-lg-none me-3"
          title="Show aside menu"
        >
          <div
            class="btn btn-icon btn-flex btn-active-color-primary"
        ...
        <div
          class="d-flex d-lg-none align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15"
        >
          <a href="#">
        ...
        >
          ...
          <div class="d-flex align-items-center">
            <a
              class="btn btn-bg-white btn-color-gray-700 btn-active-primary fw-bolder me-4"
