      ...
      >
        ...
        <div class="mb-5">
          ...
          >
            ...
            <h3 class="fs-4 text-gray-800 fw-bold mb-0 ms-4">
              {{ themeName }} v8.0.21 - 30 July, 2021
            </h3>
          </div>
          <!--end::Header-->
          ...
          >
            ...
            <h3 class="fs-6 fw-bolder show mb-1">Update:</h3>
            <ul class="py-2">
              <li class="py-2">
            ...
            <h3 class="fs-6 fw-bolder show mb-1">Fixes:</h3>
            <ul class="py-2">
              <li class="py-2">
                Fixed drawer hide then route path is changed.
                <a
        ...
        <div class="mb-5">
          ...
          >
            ...
            <h3 class="fs-4 text-gray-800 fw-bold mb-0 ms-4">
              {{ themeName }} v8.0.19 - 26 July, 2021
            </h3>
          </div>
          <!--end::Header-->
          ...
          >
            ...
            <ul class="py-2">
              <li class="py-2">
                Fixed content breadcrumb display for content-fluid.
                <a
                  href="https://preview.keenthemes.com/metronic8/vue/demo1/#/dashboard"
                  >Preview</a
                >
        ...
        <div class="mb-5">
          ...
          >
            ...
            <h3 class="fs-4 text-gray-800 fw-bold mb-0 ms-4">
              {{ themeName }} v8.0.18 - 16 July, 2021
            </h3>
          </div>
          <!--end::Header-->
          ...
          >
            ...
            <ul class="py-2">
              <li class="py-2">
                Fixed breadcrumb on mobile version.
                <a
                  href="https://preview.keenthemes.com/metronic8/vue/demo1/#/dashboard"
                  >Preview</a
                >
        ...
        <div class="mb-5">
          ...
          >
            ...
            <h3 class="fs-4 text-gray-800 fw-bold mb-0 ms-4">
              {{ themeName }} v8.0.15 - 17 June, 2021
            </h3>
          </div>
          <!--end::Header-->
          ...
          >
            ...
            <ul class="py-2">
              <li class="py-2">
                Added widgets pages
                <a
                  href="https://preview.keenthemes.com/metronic8/vue/demo1/#/crafted/widgets/lists"
                  >Preview</a
                >
              </li>
            </ul>
...
import { setCurrentPageBreadcrumbs } from "../../../../demo1/src/core/helpers/breadcrumb";
...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      setCurrentPageBreadcrumbs("Campaigns", ["Getting Started"]);
    });
