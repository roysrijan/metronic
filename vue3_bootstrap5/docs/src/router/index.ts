...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/resources/documentation/get-started/VueLaravelIntegration.vue"
          )
      },
      {
        ...
        component: () =>
          import(
            "@/views/resources/documentation/get-started/Internationalization.vue"
          )
      },
      {
        path: "dark-mode",
        name: "dark-mode",
        component: () =>
          import("@/views/resources/documentation/get-started/DarkMode.vue")
      },
      {
        path: "doc-overview",
        name: "doc-overview",
      ...
      },
      {
        ...
        component: () =>
          import("@/views/resources/documentation/base/helpers/FlexLayouts.vue")
      },
      {
        path: "helpers/text",
        name: "text",
      ...
      },
      {
        ...
        component: () =>
          import("@/views/resources/documentation/base/helpers/Background.vue")
      },
      {
      ...
      },
      {
        ...
        component: () => import("@/views/resources/documentation/base/Tabs.vue")
      },
      {
        path: "breadcrumb",
        name: "breadcrumb",
      ...
      },
      {
        ...
        name: "element-ui",
        component: () =>
          import("@/views/resources/documentation/element-ui/ElementUI.vue"),
        children: [
          {
            path: "basic/layout",
            name: "layout",
          ...
          },
          {
            ...
            name: "rate",
            component: () =>
              import("@/views/resources/documentation/element-ui/form/Rate.vue")
          },
          {
          ...
          },
          {
            ...
            name: "form",
            component: () =>
              import("@/views/resources/documentation/element-ui/form/Form.vue")
          },
          {
            path: "data/table",
            name: "table",
          ...
          },
          {
            ...
            name: "tag",
            component: () =>
              import("@/views/resources/documentation/element-ui/data/Tag.vue")
          },
          {
            path: "data/progress",
            name: "progress",
          ...
          },
          {
            ...
            name: "tree",
            component: () =>
              import("@/views/resources/documentation/element-ui/data/Tree.vue")
          },
          {
      ...
      },
      {
        ...
        component: () =>
          import("@/views/resources/documentation/general/BootstrapIcons.vue")
      },
      {
