							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-item">
											<a class="menu-link active" href="../../demo1/dist/layouts/toolbars/toolbar-3.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
								...
								<div class="d-flex align-items-center" id="kt_header_nav">
									<!--begin::Page title-->
									<div id="kt_page_title" class="page-title d-flex bg-body p-5 p-lg-0 rounded mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}">
										<!--begin::Wrapper-->
										<div class="d-flex align-items-center text-nowrap me-6">
											...
											<select class="form-select form-select-sm form-select-solid" data-control="select2" data-placeholder="The Sky 2021" data-hide-search="true">
												<option value=""></option>
												<option value="1" selected="selected">The Sky 2021</option>
										...
										<div class="d-flex align-items-center text-nowrap">
											...
											<select class="form-select form-select-sm form-select-solid w-125px" data-control="select2" data-placeholder="UnWork" data-hide-search="true">
												<option value=""></option>
												<option value="1" selected="selected">UnWork</option>
												<option value="2">In Progress</option>
												<option value="3">Done</option>
											</select>
											<!--end::Select-->
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-column flex-md-row flex-md-stack">
								...
								<div class="d-flex align-items-center me-5 mb-3 mb-md-0">
									...
									<div class="d-flex align-items-center flex-shrink-0">
										...
										<!--begin::Label-->
										<span class="fs-7 text-gray-700 fw-bolder pe-4 ps-1">Progress:</span>
										<!--end::Label-->
										<div class="progress w-100px w-xl-150px w-xxl-300px h-25px bg-light-success">
											<div class="progress-bar rounded bg-success fs-7 fw-bolder" role="progressbar" style="width: 72%;" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100">72%</div>
										</div>
									</div>
									<!--end::Section-->
								</div>
								...
								<div class="d-flex align-items-center">
									...
									<div class="me-3">
										<!--begin::Select-->
										<select class="form-select form-select-sm form-select-solid" data-control="select2" data-placeholder="Latest" data-hide-search="true">
											<option value=""></option>
									...
									<div class="m-0">
										<!--begin::Select-->
										<select class="form-select form-select-sm form-select-solid w-125px" data-control="select2" data-placeholder="Filters" data-hide-search="true">
											<option value=""></option>
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_610d4868b9db3">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_610d4868b9db3" data-allow-clear="true">
																		<option></option>
