...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Rating Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/rating.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Rating
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Rating is a custom component that can be used to display and edit star based rating.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<code>.rating-label</code>classes for displaying star based ratings. This examples uses a star icon from
										<a href="../../demo1/dist/documentation/general/icons/duotone.html" class="fw-bold">Duotone Svg Icons</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="rating">
													<div class="rating-label checked">
														<!--begin::Svg Icon | path: icons/duotone/General/Star.svg-->
...
<code class="language-html">&lt;div class="rating"&gt;
    &lt;div class="rating-label checked"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#font-icons"></a>Font Icons Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">As a star icon any font icons can be used as well. This examples uses a star icon from
										<a href="../../demo1/dist/documentation/general/icons/bootstrap-icons.html" class="fw-bold">Bootstrap Icons</a>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#states"></a>Star States</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">By default each star's state is unchecked and to mark them as checked just use
										<code>.checked</code>class for
										<code>.rating-label</code>element.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#edit"></a>Edit Mode Examples</h1>
										<!--end::Heading-->
										<!--begin::Default example-->
										<!--begin::Block-->
										<div class="py-5">Enable editable rating with Label and Radio input elements. Hover and click on the below rating to set a rating value that can be submitted along with attached radio inputs:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="rating">
													<!--begin::Reset rating-->
													<label class="btn btn-light fw-bolder btn-sm rating-label me-3" for="kt_rating_input_0">Reset</label>
													<input class="rating-input" name="rating" value="0" checked="checked" type="radio" id="kt_rating_input_0" />
													<!--end::Reset rating-->
													<!--begin::Star 1-->
...
&lt;/div&gt;</code>
										...
										<!--begin::Default example-->
										<!--begin::Block-->
										<div class="pt-15 pb-5">Rating with default value can be setup through a radio input's
										<code>checked="checked"</code>state. This examples shows a rating with 3 stars default value:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="rating">
													<!--begin::Reset rating-->
													<label class="btn btn-light fw-bolder btn-sm rating-label me-3" for="kt_rating_2_input_0">Reset</label>
													<input class="rating-input" name="rating2" value="0" checked="checked" type="radio" id="kt_rating_2_input_0" />
													<!--end::Reset rating-->
													<!--begin::Star 1-->
