...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Pulse Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/pulse.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Pulse
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Pulse is a custom component for highlighting elements.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.pulse</code>with for any element to provide a user's attentation.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex align-items-center flex-wrap">
												...
												<a href="#" class="btn btn-icon btn-light pulse me-10 mb-10">
													<!--begin::Svg Icon | path: icons/duotone/Communication/Mail-error.svg-->
													<span class="svg-icon svg-icon-1">
														<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
...
<code class="language-html">&lt;a href="#" class="btn btn-icon btn-light pulse"&gt;
...
&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.pulse-{color}</code>class to set a pulse's color:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap align-items-center">
												<a href="#" class="btn btn-icon btn-light pulse pulse-white me-10 mb-10">
													<!--begin::Svg Icon | path: icons/duotone/Layout/Layout-4-blocks.svg-->
													<span class="svg-icon svg-icon-1">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<code class="language-html">&lt;a href="#" class="btn btn-icon btn-light pulse pulse-white"&gt;
...
&lt;/a&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#border-width"></a>Border Width</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use the standard
										<code>.border-{width}</code>class with
										<code>.pulse-ring</code>to set a pulse ring's border width.</div>
										<!--end::Block-->
										<!--begin::Block-->
										...
										<ul class="pt-3">
											<li class="py-2">
											<code>0</code>- for classes that set border width to 0px</li>
											<li class="py-2">
											<code>1</code>- for classes that set border width to 1px</li>
											<li class="py-2">
											<code>2</code>- for classes that set border width to 2px</li>
											<li class="py-2">
											<code>3</code>- for classes that set border width to 3px</li>
											<li class="py-2">
											<code>4</code>- for classes that set border width to 4px</li>
											<li class="py-2">
											<code>5</code>- for classes that set border width to 5px</li>
										</ul></div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;a href="#" class="btn btn-icon btn-light pulse pulse-primary"&gt;
  &lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;
  &lt;span class="pulse-ring border-0"&gt;&lt;/span&gt;
&lt;/a&gt;
&lt;a href="#" class="btn btn-icon btn-light pulse pulse-primary"&gt;
