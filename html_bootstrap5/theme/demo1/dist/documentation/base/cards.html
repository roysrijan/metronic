...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Customized Bootstrap Cards by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/cards.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Cards</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/components/card/" class="fw-bold">Bootstrap Card</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options in
										<code>src/sass/_card.scss/</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#basic"></a>Basic Card</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Basic Card example with</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#scroll"></a>Card Scroll</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.card-scroll</code>and
										<a href="" class="fw-bolder" target="_blank">height classes</a>
										<code>.h-{size}</code>on a card's body to have a card with scrollable content:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="card shadow-sm">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#flush"></a>Flush Borders</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.card-flush</code>class to remove a card header and footer borders:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="card card-flush shadow-sm">
												...
												<div class="card-body py-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</div>
												<div class="card-footer">Footer</div>
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="card card-flush shadow-sm"&gt;
    &lt;div class="card-header"&gt;
        &lt;h3 class="card-title"&gt;Title&lt;/h3&gt;
        &lt;div class="card-toolbar"&gt;
            &lt;button type="button" class="btn btn-sm btn-light"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#reset-side-paddings"></a>Reset Side Paddings</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.card-px-0</code>to reset a card header, body and footer's side paddings:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="card card-px-0 shadow-sm"&gt;
    &lt;div class="card-header"&gt;
        &lt;h3 class="card-title"&gt;Title&lt;/h3&gt;
        &lt;div class="card-toolbar"&gt;
            &lt;button type="button" class="btn btn-sm btn-light"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="bordered">
										<a href="#bordered"></a>Bordered Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.card-bordered</code>to a card to remove it's shadow and enable borders.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="dashed">
										<a href="#dashed"></a>Dashed Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.card-dashed</code>to a card to remove it's shadow and enable dashed style borders.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="card card-dashed"&gt;
    &lt;div class="card-header"&gt;
        &lt;h3 class="card-title"&gt;Title&lt;/h3&gt;
        &lt;div class="card-toolbar"&gt;
            &lt;button type="button" class="btn btn-sm btn-light"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#stretch"></a>Card Stretch</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">To have same height cards within
										<a href="https://getbootstrap.com/docs/5.0/layout/grid/" class="">Bootstrap</a>Grid use
										...
										<ul class="pt-3">
											<li class="py-2">
											<code>stretch</code>- for setting 100% stretch height</li>
											<li class="py-2">
											<code>stretch-75</code>- for setting 75% stretch height</li>
											<li class="py-2">
											<code>stretch-50</code>- for setting 50% stretch height</li>
											<li class="py-2">
											<code>stretch-33</code>- for setting 33.333% stretch height</li>
											<li class="py-2">
											<code>stretch-25</code>- for setting 25% stretch height</li>
										</ul></div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
												<div class="highlight-code">
													<pre class="language-html" style="height:500px">
<code class="language-html">&lt;div class="row g-5"&gt;
    &lt;div class="col-lg-4"&gt;
        &lt;div class="card card-stretch card-bordered mb-5"&gt;
            &lt;div class="card-header"&gt;
                &lt;h3 class="card-title"&gt;Height 100%&lt;/h3&gt;
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#utilities"></a>Utility Classes</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.card-{property}</code>class on other elements to required card style properties defined through the SASS variables in
										...
										<ul class="pt-3">
											<li class="py-2">
											<code>p</code>- to set paddings from card</li>
											<li class="py-2">
											<code>px</code>- to set left and right paddings of card</li>
											<li class="py-2">
											<code>py</code>- to set top and bottom paddings of card</li>
											<li class="py-2">
											<code>card-rounded</code>- to set border radiuses of card</li>
											<li class="py-2">
											<code>card-rounded-top</code>- to set top left and top right radiuses of card</li>
											<li class="py-2">
											<code>card-rounded-bottom</code>- to set bottom left and top right radiuses of card</li>
										</ul></div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
