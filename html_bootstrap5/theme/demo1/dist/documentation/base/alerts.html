...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Customized Bootstrap Alerts by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/alerts.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Alerts</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/components/alerts/" target="_blank" class="fw-bold">Bootstrap Alerts</a>&#160; through creative use of Bootstrap utilities and with handpicked icons.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.alert</code>with
										<code>.alert-{color}</code>classes to set the alert's style defined with
...
&lt;!--end::Alert--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="solid">
										<a href="#solid"></a>Solid Colors</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.alert</code>with
										<code>.bg-{color}</code>classes to set the alert's style with a solid color. Please refer to our
										<a href="../../demo1/dist/documentation/base/utilities#theme-colors.html" class="me-1">Theme colors</a>for more info.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">Add the class
										<code>.alert-dismissible</code>to the parent
										<code>.alert</code>wrapper and
										<code>data-bs-dismiss="alert"</code>to the close button to allow dismissing alerts. Please take note of the HTML markup sample below for all required responsive classes.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-column">
...
&lt;!--end::Alert--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="light">
										<a href="#light"></a>Light Colors</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.alert</code>with
										<code>.bg-light-{color}</code>classes to set the alert's style with a light color. Please refer to our
										<a href="../../demo1/dist/documentation/base/utilities#theme-colors.html" class="me-1">Theme colors</a>for more info.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">Add the class
...
&lt;!--end::Alert--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#border"></a>Border Examples</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.alert</code>with
										<code>.bg-light-{color}</code>and
										<code>.border</code>classes to set the alert's style with borders. Please refer to our
										<a href="../../demo1/dist/documentation/base/utilities#theme-colors.html" class="me-1">Theme colors</a>and
										<a href="../../demo1/dist/documentation/base/helpers/borders.html" class="me-1">Borders</a>for more info.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">Add the class
										<code>.alert-dismissible</code>to the parent
...
&lt;!--end::Alert--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="rich_content">
										<a href="#rich_content"></a>Rich Content Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Here's a sample of an alert with rich content elements inside it. Please take note of the HTML markup sample below for all required classes.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-column flex-center">
												<div class="alert alert-dismissible bg-light-danger d-flex flex-center flex-column py-10 px-10 px-lg-20 mb-10">
													...
													<div class="text-center text-dark">
														...
														<br />Please read our
														<a href="#" class="fw-bolder me-1">Terms and Conditions</a>for more info.</div>
														<!--begin::Buttons-->
