...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Extended Bootstrap Pagination by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/pagination.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Pagination</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/components/pagination/" class="fw-bold">Bootstrap Pagination</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options in
										<code>src/sass/_pagination.scss</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use slightly customized pagination with previouse and next icon links:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;/ul&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Offset Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use slightly customized pagination with arrows and offset:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/ul&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Button With Text</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Previous and next buttons with text:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/ul&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Circle Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Pagination with circle buttons:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/ul&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Outline Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use slightly customized pagination with outline border:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
<code class="language-html">&lt;ul class="pagination pagination-outline"&gt;
    ...
    &lt;li class="page-item m-1"&gt;&lt;a href="#" class="page-link border"&gt;3&lt;/a&gt;&lt;/li&gt;
...
&lt;/ul&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Outline Circle Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Pagination with outline circle buttons:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
