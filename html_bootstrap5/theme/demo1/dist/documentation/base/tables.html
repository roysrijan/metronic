...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Extended Bootstrap Tables and DataTable by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/tables.html">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a class="fw-bolder me-1" href="https://getbootstrap.com/docs/5.0/content/tables/">Bootstrap Tables</a>to provide wider variants for multi-purpose usage as static tables or tables integrated with
										<a href="https://datatables.net/" class="fw-bolder me-1" target="_blank">Datatables</a>as well.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pb-10">
										...
										<a href="#basic-table"></a>Basic Table</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="my-5">
											<table class="table">
...
<code class="language-html">&lt;table class="table table-row-dashed table-row-gray-300 gy-7"&gt;
    &lt;thead&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#cell-spacing"></a>Cell Spacing</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">To control cell paddings easily,
										<a href="https://getbootstrap.com/docs/5.0/layout/gutters/" class="fw-bolder me-1">Bootstrap Gutters</a>classes
										<code>.g-*</code>&#160;,
										<code>.gy-*</code>&#160; and
										<code>.gx-*</code>&#160; can be used. Use
										<code>.gs-*</code>to set padding left to the first cell and padding right to the last cell in the row.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table gs-7 gy-7 gx-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="border-styling">
										<a href="#border-styling"></a>Row Border Styling</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.table-row-bordered</code>&#160; or
										<code>.table-row-dashed</code>&#160; class to set border bottom style row cells. To change the row border color
										<code>.table-row-gray-{100-900}</code>&#160; classes can be used.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5 pb-6">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#striped-rows"></a>Striped Rows</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-striped gy-7 gs-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#striped-rounded-bordered"></a>Striped, Rounded &amp; Bordered</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.border</code>&#160; and
										<code>.table-striped</code>&#160; to set bordered table with striped rows and make it rounded with
										<code>.table-rounded</code>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-rounded table-striped border gy-7 gs-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#flush-table"></a>Flush Table</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.table-flush</code>&#160; to reset the table and cells base styles so then style the cells individually.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-rounded table-flush"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-7 text-danger border-bottom border-gray-200 py-4"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#hoverable-rows"></a>Hoverable Rows</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.table-hover</code>&#160; to enable a hover state on table rows within a &lt;tbody&gt;</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-hover table-rounded table-striped border gy-7 gs-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#active-rows"></a>Active Rows</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Highlight a table row or cell by adding
										<code>.table-active</code>&#160; class:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-rounded table-row-bordered border gy-7 gs-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200"&gt;
            &lt;th&gt;Name&lt;/th&gt;
            &lt;th&gt;Position&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#nesting"></a>Nesting</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Border styles, active styles, and table variants are not inherited by nested tables.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7"&gt;
    &lt;thead&gt;
        &lt;tr class="fw-bold fs-4 text-gray-800"&gt;
            &lt;th scope="col"&gt;#&lt;/th&gt;
            &lt;th scope="col"&gt;First&lt;/th&gt;
...
&lt;/table&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#responsive-table"></a>Responsive Table</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Enable a table with fixed cell widths and responsive modes by referring to the official
										<a href="https://getbootstrap.com/docs/5.0/content/tables/" class="fw-bolder me-1">Bootstrap Tables</a>documentation.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="my-5">
