...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Bullet Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/bullets.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Bullets
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Bullet is a custom component used with combination with other components to display a pointer to an item in the list or navigation.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.bullet</code>in a list or navigation items as a pointer:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="d-flex flex-column">
													...
													<span class="bullet me-5"></span>Item 1</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet me-5"></span>Item 2</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet me-5"></span>Item 3</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet me-5"></span>Item 4</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet me-5"></span>Item 5</li>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
<code class="language-html">&lt;div class="d-flex flex-column"&gt;
    &lt;li class="d-flex align-items-center py-2"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#colors"></a>Colors</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.bg-{color}</code>class to set a bullets background color:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="d-flex flex-column">
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-white me-5"></span>white</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-primary me-5"></span>primary</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-light me-5"></span>light</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-secondary me-5"></span>secondary</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-success me-5"></span>success</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-info me-5"></span>info</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-warning me-5"></span>warning</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-danger me-5"></span>danger</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bg-dark me-5"></span>dark</li>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#dot-style"></a>Dot Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.bullet-dot</code>to apply a dot style bullet:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="d-flex flex-column">
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-dot me-5"></span>Item 1</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-dot bg-danger me-5"></span>Item 2</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-dot bg-success me-5"></span>Item 3</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-dot bg-info me-5"></span>Item 4</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-dot bg-primary me-5"></span>Item 5</li>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="dot-style">
										<a href="#dot-style"></a>Vertical Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.bullet-vertical</code>to apply vertical style bullet:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="d-flex flex-column">
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-vertical me-5"></span>Item 1</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-vertical bg-danger me-5"></span>Item 2</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-vertical bg-success me-5"></span>Item 3</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-vertical bg-info me-5"></span>Item 4</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-vertical bg-primary me-5"></span>Item 5</li>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#line-style"></a>Line Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.bullet-line</code>to apply a line style bullet:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="d-flex flex-column">
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-line me-5"></span>Item 1</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-line bg-danger me-5"></span>Item 2</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-line bg-success me-5"></span>Item 3</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-line bg-info me-5"></span>Item 4</li>
													<li class="d-flex align-items-center py-2">
													<span class="bullet bullet-line bg-primary me-5"></span>Item 5</li>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a class="fw-bold" href="../../demo1/dist/documentation/base/utilities#width-and-height.html" target="_blank">Custom Size Classes</a>&#160; for bullets to set custom width and height:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 d-flex flex-column flex-wrap">
												<div class="d-flex">
													...
													<span class="bullet bg-primary h-15px w-25px me-5"></span>.h-15px .w-25px</div>
													<div class="d-flex align-items-center me-15">
													<span class="bullet bg-primary h-20px w-30px me-5"></span>.h-20px .w-30px</div>
													<div class="d-flex align-items-center">
													<span class="bullet bg-primary h-30px w-50px me-5"></span>.h-30px .w-50px</div>
												</div>
												<div class="separator my-10"></div>
												<div class="d-flex">
													<div class="d-flex align-items-center me-15">
													<span class="bullet bullet-dot bg-primary h-15px w-15px me-5"></span>.h-15px .w-15px</div>
													<div class="d-flex align-items-center me-15">
													<span class="bullet bullet-dot bg-primary h-20px w-20px me-5"></span>.h-20px .w-20px</div>
													<div class="d-flex align-items-center">
													<span class="bullet bullet-dot bg-primary h-30px w-30px me-5"></span>.h-30px .w-30px</div>
												</div>
												<div class="separator my-10"></div>
												<div class="d-flex">
													<div class="d-flex align-items-center me-15">
													<span class="bullet bullet-vertical bg-primary h-25px w-15px me-5"></span>.h-25px .w-15px</div>
													<div class="d-flex align-items-center me-15">
													<span class="bullet bullet-vertical bg-primary h-30px w-20px me-5"></span>.h-30px .w-20px</div>
													<div class="d-flex align-items-center">
													<span class="bullet bullet-vertical bg-primary h-50px w-30px me-5"></span>.h-50px .w-30px</div>
												</div>
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;div class="d-flex align-items-center me-15"&gt;
