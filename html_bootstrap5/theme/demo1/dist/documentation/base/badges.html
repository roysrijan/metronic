...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Badge Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/badges.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Badges</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/components/badges/" class="fw-bold">Bootstrap Badges</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options in
										<code>src/sass/_badge</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
...
&lt;span class="badge badge-light-dark"&gt;New&lt;/span&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#square"></a>Square Badge</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.badge-square</code>class to use a badge with same width and height:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;span class="badge badge-square badge-dark"&gt;5&lt;/span&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#circle"></a>Circle Badge</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.badge-circle</code>class to use a badge with circle style:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap align-items-center">
...
&lt;span class="badge badge-circle badge-dark"&gt;5&lt;/span&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#buttons"></a>Bootstrap Buttons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use a badge with
										<code>.badge-circle</code>class in a Bootstrap Button element:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<button class="btn btn-primary position-relative me-5">Button
												<span class="position-absolute top-0 start-0 translate-middle badge badge-circle badge-danger">5</span></button>
												<button class="btn btn-success position-relative me-5">Button
												<span class="position-absolute top-100 start-0 translate-middle badge badge-circle badge-warning">5</span></button>
												<button class="btn btn-danger position-relative me-5">Button
												<span class="position-absolute top-0 start-100 translate-middle badge badge-circle badge-primary">5</span></button>
												<button class="btn btn-warning position-relative">Button
												<span class="position-absolute top-100 start-100 translate-middle badge badge-circle badge-success">5</span></button>
											</div>
										</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;button class="btn btn-primary position-relative me-5"&gt;
