...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Ribbon Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/ribbon.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Ribbon
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Ribbon is a custom micro element that can be used on a card element for additional flair.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<code>.ribbon</code>class within the
										<code>.card-header</code>element of a
										<code>.card</code>component. Then add the ribbon content within the
										<code>.card-header</code>This example uses a simple ribbon on a card component.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="rounded-corners">
										<a href="#rounded-corners"></a>Rounded Corners</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.ribbon-[direction]</code>to add rounded corners on the specified ribbon edge. The direction options are
										<code>start</code>,
										<code>end</code>,
										<code>top</code>and
										<code>bottom</code>.
										<br />Please note that the ribbon may overlap your card title, so align your titles accordingly.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Row-->
...
&lt;!--end::Card--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#vertical"></a>Vertical Ribbons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.ribbon-vertical</code>together with
										<code>.ribbon-top</code>to add a vertical ribbon.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Row-->
...
&lt;!--end::Card--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="clip">
										<a href="#clip"></a>Clip Ribbons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.ribbon-clip</code>and
										<code>.ribbon-inner</code>to add a clip style ribbon edge.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Row-->
												...
												<div class="col">
													...
													<div class="card card-bordered">
														<div class="card-header justify-content-end ribbon ribbon-start ribbon-clip">
															<div class="ribbon-label">Ribbon
															<span class="ribbon-inner bg-success"></span></div>
															<div class="card-title">Ribbon Example</div>
														</div>
														<div class="card-body">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</div>
													</div>
...
&lt;!--end::Card--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="vertical">
										<a href="#vertical"></a>Triangle Ribbons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.ribbon-triangle</code>together with one of
										<code>.ribbon-top-start</code>,
										<code>.ribbon-top-start</code>,
										<code>.ribbon-top-start</code>,
										<code>.ribbon-top-start</code>direction classes to have a triangle stle ribbon with icons positioned with the Bootstrap margin utility classes. Use
										<code>.border-{color}</code>class to set a ribbon color:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Row-->
													...
													<div class="overflow-hidden position-relative card-rounded">
														...
														<div class="ribbon ribbon-triangle ribbon-top-end border-success">
															...
															<div class="ribbon-icon mt-n5 me-n6">
																<!--begin::Svg Icon | path: icons/duotone/Devices/Bluetooth.svg-->
												...
												<div class="col">
													...
													<div class="overflow-hidden position-relative card-rounded">
														...
														<div class="ribbon ribbon-triangle ribbon-bottom-end border-gray-300">
															<!--begin::Icon-->
															<i class="bi bi-pencil position-relative me-n6 d-block fs-2 text-dark"></i>
															<!--end::Icon-->
														</div>
														<!--end::Ribbon-->
													</div>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Ribbon wrapper 1--&gt;
&lt;div class="overflow-hidden position-relative card-rounded"&gt;
    &lt;!--begin::Ribbon--&gt;
    &lt;div class="ribbon ribbon-triangle ribbon-top-start border-primary"&gt;
        &lt;!--begin::Ribbon icon--&gt;
...
&lt;div class="overflow-hidden position-relative card-rounded"&gt;
    ...
    &lt;div class="ribbon ribbon-triangle ribbon-top-start border-primary"&gt;
        &lt;!--begin::Ribbon icon--&gt;
        &lt;div class="ribbon-icon mt-n5 me-n6"&gt;
            &lt;?php echo Theme::getSvgIcon("icons/duotone/Devices/Bluetooth.svg", "svg-icon-2 svg-icon-white")?&gt;
        &lt;/div&gt;
        &lt;!--end::Ribbon icon--&gt;
    &lt;/div&gt;
    &lt;!--end::Ribbon--&gt;
