...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Extended Bootstrap Buttons by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/buttons.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Buttons</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="#overview"></a>Bootstrap Buttons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Metronic customizes the
										<a href="https://getbootstrap.com/docs/5.0/components/buttons/" class="fw-bold">Bootstrap Buttons</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options in
										<code>src/sass/buttons/</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pb-10">
										...
										<a href="#base-style"></a>Base Buttons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-{color}</code>Bootstrap Button class to set base button base color defined with
										<code>$theme-colors</code>mapped in
										<code>src/sass/_variables.scss</code>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;a href="#" class="btn btn-dark"&gt;Dark&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#light-style"></a>Light Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-light-{color}</code>Bootstrap Button class to set a button's light style defined with
...
&lt;a href="#" class="btn btn-light-dark"&gt;Dark&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#bg-style"></a>Background Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-bg-{color}</code>Bootstrap Button class to set a button's background color only without hover or active states:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-bg-white text-inverse-white me-2 mb-2">White</a>
												...
												<a href="#" class="btn btn-bg-secondary text-inverse-secondary me-2 mb-2">Secondary</a>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-bg-white"&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-bg-dark"&gt;Dark&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="outline-dashed-style">
										<a href="#outline-dashed-style"></a>Outline Dashed Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										...
										<code>.btn-active-light-{color}</code>classes to have a button with outline dashed border style:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-outline btn-outline-dashed btn-outline-default me-2 mb-2"&gt;Default&lt;/a&gt;
...
&lt;a href="#" class="btn btn-outline btn-outline-dashed btn-outline-dark btn-active-light-dark"&gt;Dark&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#color-style"></a>Color Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-color-{text-color}</code>Bootstrap Button class to set a button's text and icon colors only:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-bg-dark btn-color-white me-2 mb-2">White</a>
												<a href="#" class="btn btn-bg-light btn-color-primary me-2 mb-2">Primary</a>
												<a href="#" class="btn btn-bg-dark btn-color-secondary me-2 mb-2">Secondary</a>
												<a href="#" class="btn btn-bg-dark btn-color-light me-2 mb-2">Light</a>
												...
												<a href="#" class="btn btn-bg-dark btn-color-gray-100 me-2 mb-2">Gray-100</a>
												<a href="#" class="btn btn-bg-dark btn-color-gray-200 me-2 mb-2">Gray-200</a>
												<a href="#" class="btn btn-bg-dark btn-color-gray-300 me-2 mb-2">Gray-300</a>
...
<code class="language-html">&lt;a href="#" class="btn btn-bg-dark btn-color-white"&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-bg-light btn-color-gray-900"&gt;Gray-900&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="icon-and-text-color-styles">
										<a href="#icon-and-text-color-styles"></a>Icon &amp; Text Color Styles</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-icon-{text-color}</code>and
										<code>.btn-text-{text-color}</code>Bootstrap Button classes to set a button's icon and text colors separately:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-bg-dark btn-icon-white btn-text-white me-2 mb-2">
												...
												<!--end::Svg Icon-->Primary</a>
												<a href="#" class="btn btn-bg-dark btn-icon-secondary btn-text-secondary me-2 mb-2">
												<!--begin::Svg Icon | path: icons/duotone/Design/Image.svg-->
												<span class="svg-icon svg-icon-1">
													<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:300px">
<code class="language-html">&lt;a href="#" class="btn btn-icon-white btn-text-white"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-icon-gray-900 btn-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="active-style">
										<a href="#active-style"></a>Active Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-active-{color}</code>Bootstrap Button class to set a button's color for active &amp; hover states only:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-active-white me-2 mb-2">White</a>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-active-white"&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-active-dark"&gt;Dark&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="active-light-style">
										<a href="#active-light-style"></a>Active Light Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-active-light-{color}</code>Bootstrap Button class to set a button's light color for active &amp; hover states only:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-active-light-primary"&gt;Primary&lt;/a&gt;
...
&lt;a href="#" class="btn btn-active-light-dark"&gt;Dark&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="active-color-style">
										<a href="#active-color-style"></a>Active Color Style</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-active-color-{color}</code>Bootstrap Button class to set a button's text and icon colors for active and hover states only:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<a href="#" class="btn btn-bg-light btn-active-color-secondary me-2 mb-2">Secondary</a>
												...
												<a href="#" class="btn btn-bg-light btn-active-color-gray-100 me-2 mb-2">Gray-100</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-200 me-2 mb-2">Gray-200</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-300 me-2 mb-2">Gray-300</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-400 me-2 mb-2">Gray-400</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-500 me-2 mb-2">Gray-500</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-600 me-2 mb-2">Gray-600</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-700 me-2 mb-2">Gray-700</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-800 me-2 mb-2">Gray-800</a>
												<a href="#" class="btn btn-bg-light btn-active-color-gray-900 me-2 mb-2">Gray-900</a>
											</div>
										</div>
										<!--end::Block-->
										<!--begin::Code-->
...
<code class="language-html">&lt;a href="#" class="btn btn-bg-light btn-active-color-white"&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-bg-light btn-active-color-gray-900"&gt;Gray-900&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="active-icon-and-text-color-styles">
										<a href="#active-color-style"></a>Active Icon &amp; Text Color Styles</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-active-icon-{color}</code>and
										<code>.btn-active-text-{color}</code>Bootstrap Button classes to set a button's icon and text colors separately for active and hover states:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-bg-light btn-active-icon-white btn-active-text-white me-2 mb-2">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;a href="#" class="btn btn-active-icon-white btn-active-text-white"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;White&lt;/a&gt;
...
&lt;a href="#" class="btn btn-active-icon-gray-900 btn-active-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										...
										<a href="#icons"></a>Icons</h1>
										<!--end::Heading-->
										<!--begin::Duotone examples-->
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/general/icons/duotone.html" class="fw-bold">Duotone Svg Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-primary me-2 mb-2">
												<!--begin::Svg Icon | path: icons/duotone/Shopping/Chart-bar3.svg-->
												<span class="svg-icon svg-icon-1">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24" />
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;&lt;/a&gt;</code>
										...
										<!--end::Code-->
										<!--end::Duotone examples-->
										<!--begin::Bootstrap icons examples-->
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/general/icons/bootstrap-icons.html" class="fw-bold">Bootstrap Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<a href="#" class="btn btn-primary me-2 mb-2">
												<i class="bi bi-chat-square-text-fill fs-4 me-2"></i>Caption</a>
												<a href="#" class="btn btn-success me-2 mb-2">
												<i class="bi bi-chat-square-text-fill fs-4 me-2"></i>Caption</a>
												<a href="#" class="btn btn-info me-2 mb-2">
												<i class="bi bi-chat-square-text-fill fs-4 me-2"></i>Caption</a>
										...
										<div class="pt-5 pb-20">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-primary"&gt;&lt;i class="bi bi-chat-square-text-fill fs-4 me-2"&gt;&lt;/i&gt; Caption&lt;/a&gt;
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="bi bi-chat-square-text-fill fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/general/icons/font-awesome.html" class="fw-bold">Font Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="pt-5 pb-20">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-primary"&gt;&lt;i class="fas fa-envelope-open-text fs-4 me-2"&gt;&lt;/i&gt; Caption&lt;/a&gt;
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="fas fa-envelope-open-text fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../../demo1/dist/documentation/general/icons/line-awesome.html" class="fw-bold">Line Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-icon btn-primary"&gt;&lt;i class="las la-wallet fs-2 me-2"&gt;&lt;/i&gt; Caption&lt;/a&gt;
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="las la-wallet fs-2 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="social">
										<a href="#social"></a>Social Buttons</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-{social}</code>and
										<code>.btn-light-{social}</code>classes with
										<a href="https://fontawesome.com" class="fw-bold" target="_blank">Font Awesome</a>&#160; or
										<a href="https://icons.getbootstrap.com" class="fw-bold" target="_blank">Bootstrap Icons</a>&#160; social icons for supporting buttons with social brand logos and colors.</div>
										<!--end::Block-->
										<!--begin::Block-->
										...
										</ul>Other social colors can be added by referring to
										<a href="https://brandcolors.net/" class="fw-bold">brandcolors.net</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-icon btn-facebook me-5 "&gt;&lt;i class="fab fa-facebook-f fs-4"&gt;&lt;/i&gt;&lt;/a&gt;
...
&lt;a href="#" class="btn btn-icon btn-light-linkedin me-5 "&gt;&lt;i class="fab fa-linkedin fs-4"&gt;&lt;/i&gt;&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="link">
										<a href="#link"></a>Link Option</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-link</code>Bootstrap Button class with any other button classes to set a link buttons without side paddings:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-link btn-color-muted btn-active-color-primary me-5 mb-2"&gt;Muted&lt;/a&gt;
&lt;a href="#" class="btn btn-link btn-color-gray-500 btn-active-color-primary me-5 mb-2"&gt;Gray 500&lt;/a&gt;
&lt;a href="#" class="btn btn-link btn-color-info btn-active-color-primary me-5 mb-2"&gt;Primary&lt;/a&gt;
&lt;a href="#" class="btn btn-link btn-color-success btn-active-color-primary me-5 mb-2"&gt;Success&lt;/a&gt;
&lt;a href="#" class="btn btn-link btn-color-danger btn-active-color-primary me-5 mb-2"&gt;Danger&lt;/a&gt;
&lt;a href="#" class="btn btn-link btn-color-warning btn-active-color-primary me-5 mb-2"&gt;Warning&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="utility-classes">
										<a href="#utility-classes"></a>Utility Classes</h1>
										<!--end::Heading-->
										<!--begin::Flush utility-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.btn-flush</code>class to remove paddings, borders, background and rounded corners:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-flush"&gt;Flushed button&lt;/a&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;a href="#" class="btn btn-flex btn-primary px-6"&gt;
