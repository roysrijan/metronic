...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Indicator Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/indicator.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Indicator
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Indicator is a custom component used in combination with
										<a href="https://getbootstrap.com/docs/5.0/components/buttons/" class="fw-bold">Bootstrap Spinners</a>,
										<a href="https://getbootstrap.com/docs/5.0/components/spinners/" class="fw-bold">Bootstrap Spinners</a>&#160; and other components to provide a progress indication toggling for a user action.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.indication</code>class on a button and specify the button's label and progress message and toggle the indicator state with
										<code>data-kt-indicator="on"</code>custom HTML attribute:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;!-- Default state --&gt;
&lt;button type="button" class="btn btn-primary me-10"&gt;
...
&lt;/button&gt;</code>
									...
									<div class="pt-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Click on the below buttons to check toggling indicator state with a simple Javascript code:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<button type="button" class="btn btn-success me-10" id="kt_button_2">
													<span class="indicator-label">Submit</span>
													<span class="indicator-progress">Please wait...
													<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
												</button>
												<button type="button" class="btn btn-danger me-10" id="kt_button_3">
													<span class="indicator-label">Submit</span>
													<span class="indicator-progress">Please wait...
													<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
												</button>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47dc826af" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47dc826b6" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47dc826af" role="tabpanel">
														<div class="highlight-code">
...
button.addEventListener("click", function() {
    ...
    setTimeout(function() {
        button.removeAttribute("data-kt-indicator");
													...
													<div class="tab-pane fade" id="kt_highlight_610d47dc826b6" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
...
&lt;/button&gt;</code>
		...
		<script src="assets/js/custom/documentation/base/indicator.js"></script>
