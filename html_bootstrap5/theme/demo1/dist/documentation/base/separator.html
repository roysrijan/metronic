...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Separator Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/separator.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Separator
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Separator is a custom component to used to device page blocks with space and visual line.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pt-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.separator</code>class to place a separator with border color and add vertical space with margin spacing classes as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">Some text goes here
											<div class="separator my-10"></div>Other text goes here</div>
										</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
...
<code class="language-html">&lt;div class="separator my-10"&gt;&lt;/div&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-width" class="fw-bold">Bootstrap Border Width</a>&#160; classes to change separator border width:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="separator my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-2 my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-3 my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-4 my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-5 my-10"&gt;&lt;/div&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										...
										<div class="py-5">Use
										<code>.separator</code>class in combination with
										<a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-color" class="fw-bold">Bootstrap Border Color</a>&#160; classes to change separator's border color:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="separator border-white my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-primary my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-light my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-secondary my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-success my-10"&gt;&lt;/div&gt;
...
&lt;div class="separator border-warning my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-danger my-10"&gt;&lt;/div&gt;
&lt;div class="separator border-dark my-10"&gt;&lt;/div&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="pt-10">
										...
										<a href="#styles"></a>Styles</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.separator-dotted</code>and
										<code>.separator-dashed</code>classes to change a separator's border style:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="separator separator-dotted border-dark my-10"&gt;&lt;/div&gt;
&lt;div class="separator separator-dashed border-dark my-10"&gt;&lt;/div&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
