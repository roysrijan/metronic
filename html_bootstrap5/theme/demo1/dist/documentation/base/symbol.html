...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Symbol Component For Avatars and Images by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/symbol.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Symbol
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Symbol is a custom component for avatars or labels with content colors.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#avatar"></a>Avatar</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Refer to below example to use Symbol for avatar image display:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#avatar-bg"></a>Avatar Background</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Refer to below example to place avatar as background image:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
												...
												<div class="symbol symbol-50px me-10 mb-10">
													<div class="symbol-label" style="background-image: url('assets/media/avatars/150-8.jpg')"></div>
												</div>
												<div class="symbol symbol-50px me-10 mb-10">
													<div class="symbol-label" style="background-image: url('assets/media/avatars/150-9.jpg')"></div>
												</div>
												<div class="symbol symbol-50px me-10 mb-10">
													<div class="symbol-label" style="background-image: url('assets/media/avatars/150-10.jpg')"></div>
												</div>
												<div class="symbol symbol-50px me-10 mb-10">
													<div class="symbol-label" style="background-image: url('assets/media/avatars/150-11.jpg')"></div>
												</div>
												<div class="symbol symbol-50px me-10 mb-10">
													<div class="symbol-label" style="background-image: url('assets/media/avatars/150-12.jpg')"></div>
												</div>
											</div>
										</div>
										<!--end::Block-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#avatar-ratio"></a>Avatar Ratio</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.symbol-2by3</code>class to set avatar background image with 2 by 3 ratio:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
												...
												<div class="symbol symbol-50px symbol-2by3 me-10 mb-10">
													<div class="symbol-label" style="background-image:url('assets/media/avatars/150-2.jpg')"></div>
												</div>
												<div class="symbol symbol-50px symbol-2by3 me-10 mb-10">
													<div class="symbol-label" style="background-image:url('assets/media/avatars/150-3.jpg')"></div>
												</div>
												<div class="symbol symbol-50px symbol-2by3 me-10 mb-10">
													<div class="symbol-label" style="background-image:url('assets/media/avatars/150-4.jpg')"></div>
												</div>
												<div class="symbol symbol-50px symbol-2by3 me-10 mb-10">
													<div class="symbol-label" style="background-image:url('assets/media/avatars/150-5.jpg')"></div>
												</div>
												<div class="symbol symbol-50px symbol-2by3 me-10 mb-10">
													<div class="symbol-label" style="background-image:url('assets/media/avatars/150-6.jpg')"></div>
												</div>
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="symbol symbol-50px symbol-2by3"&gt;
    &lt;img src="assets/media/avatars/150-1.jpg" alt=""/&gt;
&lt;/div&gt;</code>
</pre>
												</div>
									...
									<div class="py-10">
										...
										<a href="#badge"></a>Label</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Set symbol label within
										<code>.symbol-label</code>element and style it with text and background utility classes:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#badge"></a>Badge</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add a badge element using
										<code>.badge</code>component inside a symbol element:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#sizes"></a>Styles</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.symbol-circle</code>and
										<code>.symbol-square</code>classes to change a symbol element's style:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Assign responsive-friendly size to a symbol element with shorthand classes. The classes are named using the format
										...
										<ul class="pt-3">
											<li class="py-2">
											<code>20px</code>- for classes that set height and width to 20px</li>
											<li class="py-2">
											<code>25px</code>- for classes that set height and width to 25px</li>
											<li class="py-2">
											<code>30px</code>- for classes that set height and width to 30px</li>
											<li class="py-2">
											<code>35px</code>- for classes that set height and width to 35px</li>
											<li class="py-2">
											<code>40px</code>- for classes that set height and width to 40px</li>
											<li class="py-2">
											<code>45px</code>- for classes that set height and width to 45px</li>
											<li class="py-2">
											<code>50px</code>- for classes that set height and width to 50px</li>
											<li class="py-2">
											<code>55px</code>- for classes that set height and width to 55px</li>
											<li class="py-2">
											<code>60px</code>- for classes that set height and width to 60px</li>
											<li class="py-2">
											<code>65px</code>- for classes that set height and width to 65px</li>
											<li class="py-2">
											<code>70px</code>- for classes that set height and width to 70px</li>
											<li class="py-2">
											<code>75px</code>- for classes that set height and width to 75px</li>
											<li class="py-2">
											<code>100px</code>- for classes that set height and width to 100px</li>
											<li class="py-2">
											<code>125px</code>- for classes that set height and width to 125px</li>
											<li class="py-2">
											<code>150px</code>- for classes that set height and width to 150px</li>
											<li class="py-2">
											<code>160px</code>- for classes that set height and width to 160px</li>
											<li class="py-2">
											<code>175px</code>- for classes that set height and width to 175px</li>
											<li class="py-2">
											<code>200px</code>- for classes that set height and width to 200px</li>
										</ul></div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="symbol symbol-30px"&gt;
  &lt;div class="symbol-label fs-2 fw-bold text-success"&gt;A&lt;/div&gt;
&lt;/div&gt;
&lt;div class="symbol symbol-50px"&gt;
  &lt;div class="symbol-label fs-2 fw-bold text-success"&gt;A&lt;/div&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="group">
										<a href="#group"></a>Group</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Wrap symbols with
										<code>.symbol-group</code>class to have a group with slighly overlapped symbols:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10 pb-0 d-flex flex-wrap">
