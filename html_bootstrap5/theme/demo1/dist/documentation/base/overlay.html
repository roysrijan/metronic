...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Overlay Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/overlay.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Overlay
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Overlay is a custom component to create an overlay effect on elements.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<code>.bg-white .bg-opacity-5</code>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Default Shown</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.overlay-block</code>on an element to display its overlay content by default:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
													...
													<div class="col-lg-4">
														...
														<div class="card overlay overlay-block">
															<div class="card-body p-0">
																...
																<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
																	<img src="assets/media/svg/misc/video-play.svg" class="h-60px" alt="" />
																</div>
															</div>
														</div>
														<!--end::Card-->
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#content-blocking"></a>Content Blocking</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.overlay-block</code>class for blocking an element content.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
														...
														<div class="card shadow">
															...
															<div class="card-body">
																<div class="overlay overlay-block card-rounded">
																	<div class="overlay-wrapper p-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to.</div>
																	<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
...
<code class="language-html">&lt;div class="card shadow"&gt;
    &lt;div class="card-header"&gt;
        &lt;h3 class="card-title"&gt;Content Blocking&lt;/h3&gt;
    &lt;/div&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="card-blocking">
										<a href="#card-blocking"></a>Card Blocking</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.overlay-block</code>class for blocking card element.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;div class="card card-border overlay overlay-block"&gt;
    &lt;div class="card-header"&gt;
        &lt;h3 class="card-title"&gt;Card Blocking&lt;/h3&gt;
    &lt;/div&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#modal-blocking"></a>Modal Blocking</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.overlay-block</code>class block a modal's content.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
														...
														<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
															<div class="modal-dialog modal-dialog-centered" role="document">
																<div class="modal-content modal-content">
																	...
																	<!--begin::Overlay-->
																	<div class="modal-body overlay overlay-block">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
																	<!--begin::Overlay Layer-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#exampleModal"&gt;Launch modal&lt;/button&gt;
