...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Rotate Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/rotate.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Rotate
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Rotate is a custom component used to rotate an element with a spesific angle when it's parent assigned with
										<code>.active</code>class. This component can be useful to change a buttons icon direction when it's
										<code>.active</code>class is toggled.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.rotate</code>class on a button and
										<code>.rotate-{degree}</code>class on a icon to rotate it to following
										<code>degree</code>options:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<ul class="pt-3 pb-5">
											<li class="py-2">
											<code>90</code>- for classes that rotates to
											<code>90 deg</code></li>
											<li class="py-2">
											<code>180</code>- for classes that rotates to
											<code>180 deg</code></li>
											<li class="py-2">
											<code>270</code>- for classes that rotates to
											<code>270 deg</code></li>
											<li class="py-2">
										...
										<div class="py-5">
											<div class="rounded border p-10 pb-5">
												<button type="button" class="btn btn-primary me-5 mb-5">Default
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												<span class="svg-icon svg-icon-2 ms-3 ms-3">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<polygon points="0 0 24 0 24 24 0 24" />
															<rect fill="#000000" opacity="0.5" transform="translate(10.000000, 12.000000) rotate(-90.000000) translate(-10.000000, -12.000000)" x="9" y="5" width="2" height="14" rx="1" />
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-primary active me-5 mb-5 rotate">90 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-primary rotate active me-5 mb-5">180 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-primary rotate active me-5 mb-5">270 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-primary rotate active me-5 mb-5">-90 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
...
<code class="language-html">&lt;button type="button" class="btn btn-primary"&gt;
...
&lt;/button&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#toggle"></a>Toggle</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Click on the below buttons to toggle the button active state and rotate the icons accordingly:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<button type="button" class="btn btn-primary me-5 rotate" id="kt_button_1">90 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												<span class="svg-icon svg-icon-2 rotate-90 ms-3">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-danger me-5 rotate" id="kt_button_2">180 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												<span class="svg-icon svg-icon-2 rotate-180 ms-3">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<!--end::Svg Icon--></button>
												<button type="button" class="btn btn-success me-5 rotate" id="kt_button_3">270 deg
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-to-right.svg-->
												<span class="svg-icon svg-icon-2 rotate-270 ms-3">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47df801ea" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47df801ef" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47df801ea" role="tabpanel">
														<div class="highlight-code">
...
button.addEventListener("click", function() {
    button.classList.toggle("active");
													...
													<div class="tab-pane fade" id="kt_highlight_610d47df801ef" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;button type="button" class="btn btn-primary rotate" id="kt_button_1"&gt;
    90 deg &lt;span class="svg-icon svg-icon-2 rotate-90"&gt;&lt;svg&gt;&lt;/svg&gt;&lt;/span&gt;
&lt;/button&gt;</code>
</pre>
														</div>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="collapse">
										<a href="#collapse"></a>Collapse</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use Rotate with
										<code>.collapsible</code>and
										<code>.collapsed</code>classes to toggle a block using
										<a href="https://getbootstrap.com/docs/5.0/components/collapse/" class="fw-bold">Bootstrap Collapse</a>&#160; and display:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<!--begin::Toggle link-->
												<a data-bs-toggle="collapse" href="#kt_toggle_block" class="btn btn-link btn-color-muted btn-active-color-primary rotate collapsible collapsed">Toggle block
												<!--begin::Svg Icon | path: icons/duotone/Navigation/Angle-down.svg-->
												<span class="svg-icon svg-icon-3 rotate-n180 ms-1">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<polygon points="0 0 24 0 24 24 0 24" />
												...
												<div id="kt_toggle_block" class="collapse">
													<div class="rounded bg-light p-10">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.</div>
												</div>
												<!--end::Toggle block-->
											</div>
										</div>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;!--begin::Toggle link--&gt;
...
&lt;!--end::Toggle block--&gt;</code>
		...
		<script src="assets/js/custom/documentation/base/rotate.js"></script>
