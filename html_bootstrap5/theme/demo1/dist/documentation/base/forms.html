...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Extended Bootstrap Form Controls by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/forms.html">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/forms/overview/" class="fw-bold">Bootstrap Forms</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options for the form elements in
										<code>src/sass/forms/</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#custom-form-control"></a>Custom Form Control</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.form-control-solid</code>class with
										<code>.form-control</code>to set solid background style for a form control:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
&lt;input type="text" class="form-control form-control-solid" placeholder="name@example.com"/&gt;
&lt;input type="text" class="form-control form-control-white" placeholder="name@example.com"/&gt;</code>
</pre>
														</div>
													</div>
													<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="custom-form-control">
										<a href="#custom-form-control"></a>Flush Form Control</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.form-control-flush</code>class with
										<code>.form-control</code>to remove the default background-color, borders, and rounded corners of a form input.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<div class="py-0">
													...
													<div class="highlight">
														...
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;input type="email" class="form-control form-control-flush" placeholder="Example input"/&gt;</code>
</pre>
														</div>
													</div>
													<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="custom-form-control">
										<a href="#custom-form-control"></a>Form Labels</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.required</code>class with
										<code>.form-label</code>or any custom element to indicate input's mandatory status:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#custom-form-select"></a>Custom Form Select</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.form-select-solid</code>class with
										<code>.form-select</code>to set solid background style for a form select:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<div class="mb-10">
													<label for="exampleFormControlTextarea1" class="form-label">White background style</label>
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#custom-checkbox-and-radio"></a>Custom Checkbox &amp; Radio</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.form-check-custom</code>and
										<code>.form-check-solid</code>class with
										<code>.form-check</code>to set custom layout with solid background style for a form check:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
										...
										<code>.form-check-{sm, lg}</code>fixed size classes for checkbox and radio to change their sizes:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<div class="mb-10">
													<div class="form-check form-check-custom form-check-solid form-check-sm">
														...
														<label class="form-check-label" for="flexRadioSm">Small radio</label>
													</div>
												</div>
												<!--begin::Code-->
												<div class="py-0">
...
&lt;/div&gt;</code>
										...
										<!--end::Block-->
										<!--begin::Block-->
										<div class="pt-15 pb-5">Use
										<a class="fw-bold" href="../../demo1/dist/documentation/base/utilities#width-and-height.html" target="_blank">Custom Size Classes</a>&#160; for checkbox and radio to set custom sizes:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#custom-switch"></a>Custom Switch</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>.form-check-custom</code>and
										<code>.form-check-solid</code>class with
										<code>.form-switch</code>to set custom layout with solid background style for a form switch:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/div&gt;</code>
										...
										<!--begin::Block-->
										<div class="pt-15 pb-5">Use
										<a class="fw-bold" href="../../demo1/dist/documentation/base/utilities#width-and-height.html" target="_blank">Custom Size Classes</a>&#160; for switches to set custom sizes:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
