...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Custom Bootstrap Layouts by Keenthemes</title>
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/helpers/flex-layouts.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Flex Layouts
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-0">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use responsive-friendly custom flex classes to build nested layouts with fixed and fluid columns. The classes are named using the format
										<code>flex-{property}</code>for
										<code>xs</code>and
										<code>flex-{breakpoint}-{property}</code>for
										<code>sm</code>,
										<code>md</code>,
										<code>lg</code>,
										<code>xl</code>, and
										...
										<ul class="pt-3">
											<li class="py-2">
											<code>root</code>- to define the root node of the flex layout(usually it's used when the layout is placed as a direct child of the body element in order to fully occupy the window height)</li>
											<li class="py-2">
											<code>column-auto</code>- to set a column with auto height</li>
											<li class="py-2">
											<code>column-fluid</code>- to set a column with fluid height</li>
											<li class="py-2">
											<code>row-auto</code>- to set a column with auto width</li>
											<li class="py-2">
											<code>row-fluid</code>- to set a column with fluid width</li>
											<li class="py-2">
											<code>center</code>- to set a column's content vertically and horizontally centered</li>
										</ul></div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;div class="d-flex flex-row h-300px"&gt;
    &lt;div class="d-flex flex-column flex-row-auto w-200px"&gt;
