...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Customized Bootstrap Breadcrumb by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/base/breadcrumb.html">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<a href="https://getbootstrap.com/docs/5.0/components/breadcrumb/" class="fw-bold">Bootstrap Breadcrumb</a>&#160; through the SASS variables in
										<code>src/sass/_variables.scss</code>and adds additonal options in
										<code>src/sass/_breadcrumb.scss</code>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use an ordered or unordered list with linked list items to create a minimally styled breadcrumb. Use our utilities to add additional styles as desired.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;ol class="breadcrumb text-muted fs-6 fw-bold"&gt;
...
&lt;/ol&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#line-separator"></a>Line Separator</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.breadcrumb-line</code>to enable line separator style for a breadcrumb.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;ol class="breadcrumb breadcrumb-line text-muted fs-6 fw-bold"&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Home&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Library&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item px-3 text-muted"&gt;Active&lt;/li&gt;
&lt;/ol&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#dot-separator"></a>Dot Separator</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.breadcrumb-dot</code>to enable dot separator style for a breadcrumb.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-bold"&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Home&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Library&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item px-3 text-muted"&gt;Active&lt;/li&gt;
&lt;/ol&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#separatorless"></a>Without Separator</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>.breadcrumb-separatorless</code>to remove the separator.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;ol class="breadcrumb breadcrumb-separatorless text-muted fs-6 fw-bold"&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Home&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item pe-3"&gt;&lt;a href="#" class="pe-3"&gt;Library&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item px-3 text-muted"&gt;Active&lt;/li&gt;
&lt;/ol&gt;</code>
