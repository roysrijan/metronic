					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started.html">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="px-md-10 pt-md-10 pb-md-5">
										...
										<div class="text-center mb-20">
											<h1 class="fs-2tx fw-bolder mb-8">Rapidly build modern web apps with
											<span class="d-inline-block position-relative ms-2">
												<span class="d-inline-block mb-2">Metronic</span>
										...
										<div class="row g-0">
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<div class="fs-4 text-gray-600 py-3">Install the dependencies using Yarn or NPM and use our custom made Gulp or Webapck build tools to get your project up and running literally in a minutes.</div>
													<a href="../../demo1/dist/documentation/getting-started/build/gulp.html" class="btn btn-lg btn-flex btn-link btn-color-info">Install now
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<div class="fs-4 text-gray-600 py-3">Just build your layout, preview it in real time and export the HTML template with it's includable partials for your server side integration.</div>
													<a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" class="btn btn-lg btn-flex btn-link btn-color-success">Preview and export
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
													<span class="svg-icon ms-2 svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<a href="../../demo1/dist/documentation/base/utilities.html" class="btn btn-lg btn-flex btn-link btn-color-danger">Learn more
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
													<span class="svg-icon ms-2 svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<div class="fs-4 text-gray-600 py-3">Our exclusive components such as KTMenu, KTPasswordMeter, KTDrawer are made to empower your next project with our novel UI/UX vision.</div>
													<a href="../../demo1/dist/documentation/forms/password-meter.html" class="btn btn-lg btn-flex btn-link btn-color-warning">Browse components
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
													<span class="svg-icon ms-2 svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<div class="fs-4 text-gray-600 py-3">All popular 3rd-party plugins are deeply customized to meet our design system requirements and look alike with the rest of the in-house components.</div>
													<a href="../../demo1/dist/documentation/forms/flatpickr.html" class="btn btn-lg btn-flex btn-link btn-color-success">Learn more
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
													<span class="svg-icon ms-2 svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<div class="col-md-6 mb-10">
												<div class="bg-light bg-opacity-50 rounded-3 p-10 mx-md-5 h-md-100">
													...
													<h1 class="mb-5">SVG &amp; Font Icons</h1>
													<div class="fs-4 text-gray-600 py-3">Fulfill your icon needs with over 5000 available icons from SVG Duotone, Bootstrap Icons, Font Awesome, and Line Awesome sets.</div>
													<a href="../../demo1/dist/documentation/general/icons/duotone.html" class="btn btn-lg btn-flex btn-link btn-color-primary">Browse icons
													<!--begin::Svg Icon | path: icons/duotone/Navigation/Arrow-right.svg-->
													<span class="svg-icon ms-2 svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
