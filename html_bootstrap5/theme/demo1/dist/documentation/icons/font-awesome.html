...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Fontawesome Icons and Flaticon Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/icons/font-awesome.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">Icons</li>
												<!--end::Item-->
												<!--begin::Item-->
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Font Awesome</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Get vector icons and social logos on your website with
										<a href="https://fontawesome.com/" class="fw-bold" target="_blank">Font Awesome</a>, the web's most popular icon set and toolkit. Font Awesome Free package included in Metronicand can be used right away by browsing the
										<a href="https://fontawesome.com/icons?d=gallery&amp;m=free" class="fw-bold" target="_blank">Free Font Awesome Icons</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#usage"></a>Ugage</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use Font Awesome icons with spesific class as explained in the
										<a class="fw-bold" href="https://fontawesome.com/icons/affiliatetheme?style=brands" target="_blank">Icon Preview Page</a>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;i class="fas fa-envelope-open-tex"&gt;&lt;/i&gt;
...
&lt;i class="fas fa-pen-nib"&gt;&lt;/i&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#icon-colors"></a>Icon Colors</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The inline icons can be colored using
...
<code class="language-html">&lt;i class="far fa-lightbulb text-white"&gt;&lt;/i&gt;
...
&lt;i class="far fa-lightbulb text-gray-900"&gt;&lt;/i&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-3" id="icon-sizes">
										<a href="#icon-sizes"></a>Icon Sizes</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The font icons can be sized using
										...
										<div class="py-5">
											<div class="rounded border d-flex flex-wrap p-10">
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													...
													<div class="fw-bold py-2 text-center">.fs-5x</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-4x"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-4x</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-3x"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-3x</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-2tx"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-2tx</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-2hx"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-2hx</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-2qx"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-2qx</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-2x"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-2x</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-1"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-1</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-2"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-2</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-3"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-3</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-5"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-5</div>
												</div>
												<div class="d-flex flex-column h-100px w-100px me-10 mb-5">
													<div class="d-flex flex-center flex-grow-1">
														<i class="far fa-lightbulb fs-6"></i>
													</div>
													<div class="fw-bold py-2 text-center">.fs-6</div>
												</div>
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;i class="far fa-lightbulb fs-5x"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-4x"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-3x"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-2tx"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-2hx"&gt;&lt;/i&gt;
...
&lt;i class="far fa-lightbulb fs-3"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-5"&gt;&lt;/i&gt;
&lt;i class="far fa-lightbulb fs-6"&gt;&lt;/i&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
