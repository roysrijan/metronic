...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Bootstrap Icons and Flaticon Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/icons/bootstrap-icons.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Bootstrap Icons</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<a href="https://icons.getbootstrap.com/" target="_blank" class="fw-bold">Bootstrap Icons</a>&#160; is a free, high quality, open source icon library with nearly 1,200 icons. Include them anyway you like SVGs, SVG sprite, or web fonts.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use Bootstrap Icons with a spesific class as explained in the
										<a class="fw-bold" href="https://icons.getbootstrap.com/icons/alarm-fill/" target="_blank">Icons Preview Page</a>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;i class="bi bi-bookmarks-fill fs-2x"&gt;&lt;/i&gt;
...
&lt;i class="bi bi-vector-pen fs-2x"&gt;&lt;/i&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
...
<code class="language-html">&lt;i class="bi bi-droplet-half text-white"&gt;&lt;/i&gt;
...
&lt;i class="bi bi-droplet-half text-gray-900"&gt;&lt;/i&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="pt-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;i class="bi bi-droplet-half fs-5x"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-4x"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-3x"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-2tx"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-2hx"&gt;&lt;/i&gt;
...
&lt;i class="bi bi-droplet-half fs-3"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-5"&gt;&lt;/i&gt;
&lt;i class="bi bi-droplet-half fs-6"&gt;&lt;/i&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
