...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Select2 and Bootstrap Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/select2.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Select2</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<strong class="me-1">Select2</strong>gives you a customizable select box with support for searching, tagging, remote data sets, infinite scrolling, and many other highly used options. For full documentation please check the
										<a href="https://select2.org" target="_blank" class="fw-bold">plugin's site</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Select2's CSS and Javascript files are bundled in the global plugin bundles and globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Select2's CSS is highly customized in
												<code>sass/vendors/plugins/_select2.scss</code>SCSS file in order to use it as native component within the design system. The SCSS code is compiled into
												<code>assets/plugins/global/plugins.bundle.css</code>and globally included in all pages.</li>
												<li class="py-2">Select2's Javascript is globally initialized with some predefined settings in
												<code>src/js/vendors/plugins/select2.init.js</code>and the initialization code is bundled within
												<code>assets/plugins/global/plugins.bundle.js</code>and globally included in all pages.</li>
												<li class="py-2">Select2's is globally initialized through
												<code>data-control="select2"</code>HTML attribute as defined in
												<code>src/js/layout/app.js</code>and some options can be be passed through
												<a class="fw-bold">Select2 Data Attributes</a>.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Basic examples of Select2 usage with default and solid background input styles:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<div class="mb-10">
													<label for="" class="form-label">White background style</label>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select" data-control="select2" data-placeholder="Select an option"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
    &lt;option value="2"&gt;Option 2&lt;/option&gt;
&lt;/select&gt;
...
&lt;/select&gt;</code>
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">Add
												<code>&lt;option&gt;&lt;/option&gt;</code>empty option in order to display the placeholder when selection is not made.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">Add
												<code>data-dropdown-parent="#modal_element_id"</code>option to fix uneditable search input when Select2 is used on Bootstrap Modal with
												<code>tabindex="-1"</code>.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
									...
									<div class="py-10">
										...
										<code>.form-select-sm</code>and
										<code>.form-select-lg</code>:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select form-select-sm form-select-solid" data-control="select2" data-placeholder="Select an option"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
    &lt;option value="2"&gt;Option 2&lt;/option&gt;
&lt;/select&gt;
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="clear-selection">
										<a href="#clear-selection"></a>Clear Selection</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>data-allow-clear="true"</code>attribute to allow clearing selected options.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-allow-clear="true"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="hide-search">
										<a href="#hide-search"></a>Hide Search</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>data-hide-search="true"</code>attribute to hide the search input in the dropdown list.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-hide-search="true"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
    &lt;option value="2" selected&gt;Option 2&lt;/option&gt;
    &lt;option value="3"&gt;Option 3&lt;/option&gt;
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="multiple-selection">
										<a href="#multiple-selection"></a>Multiple Selection</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Declare a selectbox with
										<code>multiple="multiple"</code>attribute to allow multiple selection with a tag control.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												<div class="mb-10">
													<label for="" class="form-label">Multiple Selection</label>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="1"&gt;Option 1&lt;/option&gt;
    &lt;option value="2"&gt;Option 2&lt;/option&gt;
&lt;/select&gt;
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="hierarchical-options">
										<a href="#hierarchical-options"></a>Hierarchical Options</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use
										<code>&lt;optgroup&gt;&lt;/optgroup&gt;</code>tag to display options in single level groups:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;/select&gt;</code>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Use Select2 within Bootstrap Modal:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;!--end::Modal--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="validation-states">
										<a href="#validation-states"></a>Validation States</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The standard
										<a href="https://getbootstrap.com/docs/5.0/forms/validation/" class="fw-bold">Bootstrap's Form Validation</a>&#160; classes are supported:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html" style="height:400px">
<code class="language-html">&lt;form class="was-validated"&gt;
    &lt;div class="mb-10"&gt;
        &lt;label for="" class="form-label"&gt;Valid state&lt;/label&gt;
        &lt;select class="form-select form-select-solid is-valid" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple"&gt;
            &lt;option&gt;&lt;/option&gt;
