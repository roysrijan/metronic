...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Inputmask plugin and Bootstrap Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/inputmask.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Inputmask</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Inputmask is a javascript library that creates an input mask. Inputmask can run against vanilla javascript, jQuery, and jqlite. For full documentation please check the
										<a href="https://github.com/RobinHerbots/Inputmask" target="_blank" class="fw-bold">plugin's documentation</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Inputmask's Javascript files are bundled in the global plugin bundles and globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
<code class="language-html">&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Inputmask instances can be initialized via
												<code>new Inputmask()</code>class as explained in the
												<a href="https://github.com/RobinHerbots/Inputmask#via-inputmask-class" class="fw-bold">Documentation</a>.</li>
												<li class="py-2">Inputmask instances can be initialized via
												<code>data-inputmask</code>HTML attribute as explained in the
												<a href="https://github.com/RobinHerbots/Inputmask#via-data-inputmask-attribute" class="fw-bold">Documentation</a>.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="examples">
										<a href="#examples" data-kt-scroll-toggle=""></a>Examples</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Some examples of using Inputmaks with variouse options:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
												<div class="highlight-code">
													<pre class="language-js" style="height:400px">
<code class="language-js">// Date
Inputmask({
    "mask" : "99/99/9999"
}).mask("#kt_inputmask_1");
