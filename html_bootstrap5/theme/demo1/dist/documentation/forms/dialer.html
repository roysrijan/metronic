					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/dialer.html">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Dialer is an exclusive plugin of Metronic that enables user-friendly click based dialing functionality for any text input.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Dialer's CSS and Javascript files are bundled in the global style and scripts bundles and are globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Dialer does not come with its own custom CSS and it uses global input controls and related elements.</li>
												<li class="py-2">Dialer instances are automatically initialized through
												<code>data-kt-dialer="true"</code>HTML attribute on document ready event.</li>
												<li class="py-2">Dialer instances can be created programmatically without using the above HTML attribute. See below for more info.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
										...
										<div class="py-5">
											<div class="rounded border p-10">
												<div>
													...
													<!--begin::Dialer-->
													<div class="input-group w-md-300px" data-kt-dialer="true" data-kt-dialer-min="1000" data-kt-dialer-max="50000" data-kt-dialer-step="1000" data-kt-dialer-prefix="$">
														...
														<!--begin::Input control-->
														<input type="text" class="form-control" readonly="readonly" placeholder="Amount" value="$10000" data-kt-dialer-control="input" />
														<!--end::Input control-->
...
&lt;!--end::Dialer--&gt;</code>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The Look and feel can be easily customized by using any input, button or icon variations:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;!--end::Dialer--&gt;</code>
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">While customizing the look and feel, ensure to maintain the control attributes(
												<code>data-kt-dialer-control="*"</code>) in order Dialer to function as expected.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e1e7449" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e1e7451" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e1e7449" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Dialer--&gt;</code>
									...
									<div class="py-10">
										...
										<code>option</code>below that represents the Javascript options object key:</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-5">
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The following are the Dialer's functionality methods for more control.</div>
										<!--end::Block-->
										<!--begin::Table-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														...
														<tr>
															...
															<code>[data-kt-dialer="true"]</code>. This method can be used to initialize dynamicly populated Bootstrap Dialer instances(e.g: after Ajax request).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
var dialerObject = new KTDialer(dialerElement, options);</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<code>data-kt-dialer="true"</code>attribute to avoid lazy initializes.</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
															<!--begin::Information-->
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
																...
																<code>options</code>object refer to above Options Reference section.</div>
																<!--end::Description-->
															</div>
															<!--end::Information--></td>
														</tr>
...
dialerObject.on('kt.dialer.increase', function(){
    // do something...
		...
		<script src="assets/js/custom/documentation/forms/dialer.js"></script>
