...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Clipboard.js and Bootstrap integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/clipboard.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Clipboard</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<strong class="me-1">Clipboard</strong>is a modern approach to copy text to clipboard. No Flash. No frameworks. For full documentation please check the
										<a href="https://clipboardjs.com/" target="_blank" class="fw-bold">plugin's site</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<strong>Clipboard</strong>'s CSS and Javascript files are bundled in the global plugin bundles and globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#basic"></a>Basic Usage</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply add the attribute
										<code>data-clipboard-target</code>to an action button with the input element's
										<code>id</code>to get it working. Then add the clipboard JS to initialize it.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e140e71" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e140e78" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e140e71" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Select elements
...
clipboard.on('success', function(e) {
    ...
    setTimeout(function(){
        button.innerHTML = currentLabel;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e140e78" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Cut Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add
										<code>data-clipboard-action="cut"</code>to the action button element to define a cut action. Then add the clipboard JS to initialize it.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
											<div class="card card-bordered">
												<div class="card-body">
													...
													<!--end::Input-->
													<!--begin::Button-->
													<button class="btn btn-light-primary" data-clipboard-action="cut" data-clipboard-target="#kt_clipboard_2">Cut</button>
													<!--end::Button-->
												</div>
											</div>
											<!--end::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e141185" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e14118a" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e141185" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Select elements
...
clipboard.on('success', function(e) {
    ...
    setTimeout(function(){
        button.innerHTML = currentLabel;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e14118a" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Predefined Value</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add the
										<code>data-clipboard-text</code>to an action button and it will copy the value set on click. Then add the clipboard JS to initialize it.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
											<div class="card card-bordered">
												<div class="card-body">
													<!--begin::Button-->
													<button id="kt_clipboard_3" class="btn btn-light-primary" data-clipboard-text="Just because you can doesn't mean you should — clipboard.js">Copy to clipboard</button>
													<!--end::Button-->
												</div>
											</div>
											<!--end::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e141447" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e14144b" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e141447" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Select element
...
clipboard.on('success', function (e) {
    ...
    setTimeout(function () {
        target.innerHTML = currentLabel;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e14144b" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
        &lt;!--begin::Button--&gt;
        &lt;button class="btn btn-light-primary" data-clipboard-text="Just because you can doesn't mean you should — clipboard.js"&gt;
            Copy to clipboard
        &lt;/button&gt;
        &lt;!--end::Button--&gt;
    &lt;/div&gt;
&lt;/div&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Static Element</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add the attribute
										<code>data-clipboard-target</code>to an action button with the static element's
										<code>id</code>to get it working. Then add the clipboard JS to initialize it.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e141a25" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e141a29" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e141a25" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Select elements
...
clipboard.on('success', function (e) {
    ...
    setTimeout(function () {
        ...
        button.classList.remove('btn-success');
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e141a29" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
		...
		<script src="assets/js/custom/documentation/forms/clipboard.js"></script>
