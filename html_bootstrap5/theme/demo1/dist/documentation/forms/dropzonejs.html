...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>DropzoneJS and Bootstrap Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/dropzonejs.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">DropzoneJS</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<b>DropzoneJS</b>&#160;is an open source library that provides drag’n’drop file uploads with image previews. It’s lightweight, doesn’t depend on any other library (like jQuery) and is highly customizable. For full documentation please check the
										<a href="https://www.dropzonejs.com/" target="_blank" class="fw-bold">plugin's official site</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<b>DropzoneJS's</b>&#160;CSS and Javascript files are bundled in the global plugin bundles and globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												...
												<code>sass/vendors/plugins/_dropzone.scss</code>SCSS file in order to use it as native component within the design system. The SCSS code is compiled into
												<code>assets/plugins/global/plugins.bundle.css</code>and globally included in all pages.</li>
												<li class="py-2">
												<b>DropzoneJS</b>&#160;Javascript is globally initialized with some predefined settings in
												<code>src/js/vendors/plugins/dropzone.init.js</code>and the initialization code is bundled within
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<b>DropzoneJS</b>&#160;example with manual file attachment and upload controls.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e2552e6" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e2552ec" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e2552e6" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">var myDropzone = new Dropzone("#kt_dropzonejs_example_1", {
    ...
    accept: function(file, done) {
        if (file.name == "wow.jpg") {
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e2552ec" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="queue">
										<a href="#queue"></a>Queue Upload</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
										<b>DropzoneJS</b>&#160;example with multiple file attachment with preview and cancel action.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e255600" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e255608" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e255600" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// set the dropzone container id
...
myDropzone.on("removedfile", function(file){
    if(myDropzone.files.length &lt; 1) {
        $( id + " .dropzone-upload, " + id + " .dropzone-remove-all").css("display", "none");
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e255608" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form class="form" action="#" method="post"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="queue">
										<a href="#queue"></a>Queue Auto Upload</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
										<b>DropzoneJS</b>&#160;example with manual file attachment and auto upload.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e2559ae" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e2559b3" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e2559ae" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// set the dropzone container id
...
myDropzone.on("complete", function(progress) {
    ...
    setTimeout(function(){
        $( thisProgressBar + " .progress-bar, " + thisProgressBar + " .progress").css("opacity", "0");
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e2559b3" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form class="form" action="#" method="post"&gt;
