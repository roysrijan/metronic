							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/formvalidation/advanced.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">FormValidation</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item">
													<span class="bullet w-5px h-2px"></span>
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Advanced</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
										...
										<!--end::Icon-->
										<!--begin::Description-->
										<div class="text-gray-700 fw-bold fs-6 lh-lg">FormValidation is one of the best validation library for JavaScript. For more info see
										<a href="https://formvalidation.io/" class="fw-bolder me-1">the official site</a>and
										<a class="fw-bolder" href="https://github.com/form-validation/formvalidation.io">the Github repository</a>.</div>
										<!--end::Description-->
									</div>
									<!--end::Notice-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#advanced" data-kt-scroll-toggle=""></a>Advanced Inputs Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Here's an example of multiple advanced
										<code>input</code>types within a
										<code>form</code>that has FormValidation attached to it.</div>
										<!--end::Block-->
										<!--begin::Notice-->
										<div class="py-5">
											<!--begin::Information-->
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">All input types require the
												<code>name</code>attribute to bind the input field for validation.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">FormValidation is best used together with our integrated SweetAlert2. For more info, please visit the
												<a href='https://sweetalert2.github.io/' target='_blank'>official website</a>.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="daterangepicker">
										<a href="#daterangepicker" data-kt-scroll-toggle=""></a>Date range picker</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on Date Range Pickers, please visit the
										<a href="https://www.daterangepicker.com/" target="_blank">official website</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3a95b9" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3a95bf" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3a95b9" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3a95bf" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="flatpickr">
										<a href="#flatpickr" data-kt-scroll-toggle=""></a>Flatpickr</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on Flatpickr, please visit the
										<a href="https://flatpickr.js.org/" target="_blank">official website</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9893" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9897" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3a9893" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3a9897" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_flatpickr" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="daterangepicker">
										<a href="#basic" data-kt-scroll-toggle=""></a>Image Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on our exclusive Image Input form, please visit the
										<a href="../../demo1/dist/documentation/forms/image-input.html" target="_blank">our documentation page</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9bd8" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9bdc" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3a9bd8" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3a9bdc" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_image_input" class="form" action="#" autocomplete="off"&gt;
    ...
    &lt;div class="fv-row mb-7"&gt;
        ...
        &lt;!--begin::Image input--&gt;
        &lt;div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(&lt;?php echo Theme::getMediaUrlPath(); ?&gt;avatars/blank.png)"&gt;
            &lt;!--begin::Preview existing avatar--&gt;
            &lt;div class="image-input-wrapper w-125px h-125px" style="background-image: url(&lt;?php echo Theme::getMediaUrlPath(); ?&gt;avatars/blank.png);"&gt;&lt;/div&gt;
            &lt;!--end::Preview existing avatar--&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="password">
										<a href="#password" data-kt-scroll-toggle=""></a>Password Meter</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on our exclusive Password Meter, please visit the
										<a href="../../demo1/dist/documentation/forms/password-meter.html" target="_blank">our documentation page</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9f9b" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3a9fa0" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3a9f9b" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3a9fa0" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_password" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="select2">
										<a href="#select2" data-kt-scroll-toggle=""></a>Select2</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on Select2, please visit the
										<a href="https://select2.org/" target="_blank">official website</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
												...
												<form id="kt_docs_formvalidation_select2" class="form" action="#" autocomplete="off">
													...
													<div class="fv-row mb-10">
														...
														<!--end::Label-->
														<!--begin::Select2-->
														<select class="form-select" name="select2_input" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
															<option></option>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3aa341" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3aa346" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3aa341" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3aa346" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_select2" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="tagify">
										<a href="#tagify" data-kt-scroll-toggle=""></a>Tagify</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">For more information on Tagify, please visit the
										<a href="https://yaireo.github.io/tagify/" target="_blank">official website</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e3aa695" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e3aa69a" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e3aa695" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e3aa69a" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_tagify" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
		...
		<script src="assets/js/custom/documentation/forms/formvalidation/advanced.js"></script>
