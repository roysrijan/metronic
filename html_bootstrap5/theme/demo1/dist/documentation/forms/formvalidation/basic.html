							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/formvalidation/basic.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-10">
										...
										<a href="#basic" data-kt-scroll-toggle=""></a>Basic Inputs Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Here's an example of multiple basic
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="text">
										<a href="#text" data-kt-scroll-toggle=""></a>Text Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e35b198" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e35b1a0" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e35b198" role="tabpanel">
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e35b1a0" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="email">
										<a href="#email" data-kt-scroll-toggle=""></a>Email Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e35b4f7" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e35b4fc" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e35b4f7" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e35b4fc" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_email" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="textarea">
										<a href="#textarea" data-kt-scroll-toggle=""></a>Textarea Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e35b821" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e35b826" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e35b821" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e35b826" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_textarea" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="radio">
										<a href="#radio" data-kt-scroll-toggle=""></a>Radio Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e35bb20" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e35bb24" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e35bb20" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e35bb24" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_radio" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="checkbox">
										<a href="#checkbox" data-kt-scroll-toggle=""></a>Checkbox Input</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e35be43" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e35be47" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e35be43" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e35be47" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_checkbox" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
		...
		<script src="assets/js/custom/documentation/forms/formvalidation/basic.js"></script>
