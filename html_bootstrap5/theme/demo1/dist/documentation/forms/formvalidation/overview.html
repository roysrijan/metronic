						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/forms/formvalidation/overview.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Overview</span>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">FormValidation is one of the best validation library for JavaScript. For more info see
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">FormValidation's Javascript bundles are globally included in all pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="pt-10">
										...
										<div class="pt-5">
											<ul class="py-0">
												<li class="py-2">FormValidation is primarily initialized via Javascript by adding a unique
												<code>id</code>to the
												<code>form</code>element.</li>
												<li class="py-2">Add
												<code>fv-row</code>CSS class to the input group to identify the input field that requires FormValidation</li>
												<li class="pt-2">Please refer to the
												<a href="https://formvalidation.io/guide/getting-started" target="_blank" class="me-1">official documentation</a>for all validation options available.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
