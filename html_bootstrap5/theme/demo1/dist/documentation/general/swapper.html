...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Swapper Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/swapper.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Swapper
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Swapper is an exclusive component of Metronic that provides a simple and elegent solution to re-position HTML elements based on specific screen breakpoints.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Swapper's Javascript bundles are globally included in all pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Swapper is initialized by adding
												<code>data-kt-swapper="true"</code>to the root of the HTML that will be swapped positions.</li>
												<li class="py-2">Add
												<code>data-kt-swapper-mode="prepend"</code>to the root HTML element to configure if the swapped element would be appended or prepended within the parent.</li>
												<li class="py-2">Add
												<code>data-kt-swapper-parent="{default: '#parent_container_1', lg: '#parent_container_2'}"</code>to identify the parent containers that the swapping component will be added into based on Bootstrap's breakpoint sizes.</li>
												<li class="py-2">Swapper instances can also be controlled programmatically.
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Here's a basic example of Swapper. Try the demo below by adjusting your browser width.</div>
										<!--end::Block-->
										<!--begin::Notice-->
										<div class="py-5">
											<!--begin::Information-->
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">All child elements within the Swapper component will also swap parents.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
												...
												<div class="row g-10">
													<div class="col-lg-6">
														<div class="bg-light-primary h-100 p-5" id="kt_docs_swapper_parent_1">
															...
															<!--begin::Swapper-->
															<div class="mt-3" data-kt-swapper="true" data-kt-swapper-mode="append" data-kt-swapper-parent="{ default: '#kt_docs_swapper_parent_4', md: '#kt_docs_swapper_parent_3', lg: '#kt_docs_swapper_parent_2', xl: '#kt_docs_swapper_parent_1' }">This HTML element will swap parent elements on different screen breakpoints</div>
															<!--end::Swapper-->
														</div>
													</div>
													<div class="col-lg-6">
...
<code class="language-html">&lt;div class="row g-10"&gt;
    &lt;div class="col-lg-6"&gt;
        &lt;div class="bg-light-primary h-100 p-5" id="kt_docs_swapper_parent_1"&gt;
            &lt;div class="fw-boldest"&gt;Parent Element 1&lt;/div&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Swapper uses HTML attributes to set specific configurations. Here are the references for each below</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
												...
												<table class="table table-striped align-top mb-0 g-5">
													...
													<tbody>
														<tr>
															...
															<td>Enables the current element as the Swapper component. Accepts
															<code>true</code>or
														...
														<tr>
															...
															<td>Defines the re-positioning method. Accepts
															<code>append</code>or
															<code>prepend</code>. Defaults to
															<code>append</code>.</td>
														</tr>
														<tr>
															<td>
															...
															<td>
															<div class="mb-3">Defines the parent element to be swapped into at specific Bootstrap breakpoints. This is compatible with Bootstrap's standard breakpoint sizing (eg:
															...
															<code>{default: '#parent_container_1', lg: '#parent_container_2'}</code>that the swapper component will swap the parent element from
															<code>#parent_container_1</code>to
															<code>#parent_container_2</code>when the screen grows from smaller sizes to
															<code>lg</code>size or bigger and vice versa.</td>
														</tr>
													</tbody>
												</table>
											</div>
									...
									<div class="pt-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">All Swapper components are initialized automatically, however the following are Password Meter's functionality methods for more control.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="pt-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>Initializes Swapper instances by selector. Default value of
															<code>selector</code>is
															<code>[data-kt-swapper="true"]</code>. This method can be used to initialize dynamicly populated Swapper instances(e.g: after Ajax request).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">KTSwapper.createInstances();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Get the Swapper instance created
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">var swapperElement = document.querySelector("#kt_swapper_control");
var swapper = KTSwapper.getInstance(swapperElement);</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
													...
													<tbody>
														<tr>
															...
															<td>Forces the Swapper component to update and re-position depending on screen size.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">swapper.update();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
