...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Toastr and Bootstrap Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/toastr.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Toastr</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<strong class="me-1">Toastr</strong>is a Javascript library for Gnome / Growl type non-blocking notifications. For more info please visit the plugin's
										<a class="me-1" href="https://codeseven.github.io/toastr/demo.html" target="_blank">Home</a>or
										<a href="https://github.com/CodeSeven/toastr" target="_blank">Github Repo</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<strong>Toastr</strong>'s CSS and Javascript files are bundled in the global style and scripts bundles and are globally included in all pages:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="form">
										<a href="#form"></a>Toastr Notifications Examples</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
												...
												<div class="card-body">
													...
													<form class="form">
														...
														<div class="row g-10">
															...
															<div class="col-lg-2">
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3">Toast Type</label>
																	<div class="d-flex flex-column" id="toastTypeGroup">
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="success" name="toasts" checked="checked" />
																			<span class="form-check-label">Success</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="info" name="toasts" />
																			<span class="form-check-label">Info</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="warning" name="toasts" />
																			<span class="form-check-label">Warning</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm">
																			<input class="form-check-input" type="radio" value="error" name="toasts" />
																...
																<div class="form-group">
																	...
																	<div class="d-flex flex-column" id="positionGroup">
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-top-right" name="positions" checked="checked" />
																			<span class="form-check-label">Top Right</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-bottom-right" name="positions" />
																			<span class="form-check-label">Bottom Right</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-bottom-left" name="positions" />
																			<span class="form-check-label">Bottom Left</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-top-left" name="positions" />
																			<span class="form-check-label">Top Left</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-top-full-width" name="positions" />
																			<span class="form-check-label">Top Full Width</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-bottom-full-width" name="positions" />
																			<span class="form-check-label">Bottom Full Width</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-top-center" name="positions" />
																			<span class="form-check-label">Top Center</span>
																		</label>
																		<label class="form-check form-check-custom form-check-solid form-check-sm mb-2">
																			<input class="form-check-input" type="radio" value="toast-bottom-center" name="positions" />
																			<span class="form-check-label">Bottom Center</span>
																		</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="showEasing">Show Easing</label>
																	<input id="showEasing" type="text" class="form-control mb-2" placeholder="swing, linear" value="swing" />
																</div>
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="hideEasing">Hide Easing</label>
																	<input id="hideEasing" type="text" class="form-control mb-2" placeholder="swing, linear" value="linear" />
																</div>
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="showMethod">Show Method</label>
																	<input id="showMethod" type="text" class="form-control mb-2" placeholder="show, fadeIn, slideDown" value="fadeIn" />
																</div>
																<div class="form-group">
																	<label class="fw-bolder mb-3" for="hideMethod">Hide Method</label>
																	<input id="hideMethod" type="text" class="form-control mb-2" placeholder="hide, fadeOut, slideUp" value="fadeOut" />
																</div>
																<a href="http://www.gsgd.co.uk/sandbox/jquery/easing/" target="_blank" class="font-weight-bold">See all easing options</a>
															</div>
															<div class="col-lg-2">
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="showDuration">Show Duration</label>
																	<input id="showDuration" type="text" class="form-control" placeholder="ms" value="300" />
																</div>
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="hideDuration">Hide Duration</label>
																	<input id="hideDuration" type="text" class="form-control" placeholder="ms" value="1000" />
																</div>
																<div class="form-group mb-5">
																	<label class="fw-bolder mb-3" for="timeOut">Time out</label>
																	<input id="timeOut" type="text" class="form-control" placeholder="ms" value="5000" />
																</div>
																<div class="form-group">
																	<label class="fw-bolder mb-3" for="extendedTimeOut">Extended time out</label>
															...
															<div class="col-lg-12">
																<div class="form-group">
																	<div class="position-relative my-9">
																		<span class="btn btn-icon btn-light btn-sm position-absolute top-0 end-0 m-2" data-bs-toggle="tooltip" title="Copy code">
														...
														<!--begin::Actions-->
														<div class="d-flex">
															<a href="javascript:;" class="btn btn-primary my-1" id="showtoast">Show Toast</a>
															<a href="javascript:;" class="btn btn-light-primary my-1 mx-3" id="cleartoasts">Clear Toasts</a>
															<a href="javascript:;" class="btn btn-light-primary my-1" id="clearlasttoast">Clear Last Toast</a>
														</div>
														<!--end::Actions-->
													</form>
													<!--end::Form-->
		...
		<script src="assets/js/custom/documentation/general/toastr.js"></script>
