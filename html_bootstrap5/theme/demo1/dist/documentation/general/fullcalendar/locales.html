...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Fullcalendar Localization and Bootstrap Integration by Keenthemes</title>
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/fullcalendar/locales.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Localization</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-10">
										...
										<!--begin::Block-->
										<div class="py-5">
											<div class="mb-3">Fullcalendar localization demo. For more info, please visit the
											<a href="https://fullcalendar.io/docs/localization" target="_blank">official documentation</a>.</div>
										</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											...
											<div class="mb-15 w-300px">
												...
												<select id='kt_docs_fullcalendar_locale_selector' class="form-select" data-control="select2" data-placeholder="Select an option">
													<option></option>
												</select>
											</div>
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47f43ab05" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47f43ab0c" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47f43ab05" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define variables
...
calendar.render();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_610d47f43ab0c" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Fullcalendar--&gt;</code>
		...
		<script src="assets/js/custom/documentation/general/fullcalendar/locales.js"></script>
