...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Cookie Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/cookie.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Cookie
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Cookie is an exclusive component of Metronic that provides a simple integrated way to manage cookies via Javascript. For more info on cookies, please visit:
										<a href="https://javascript.info/cookie" target="_blank">https://javascript.info/cookie</a></div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Cookie's Javascript bundles are globally included in all pages. However, custom cookie management will require additional JS to be included.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Cookie is globally initialized and can be controlled via our custom
												<code>get</code>,
												<code>set</code>and
												<code>remove</code>API methods.</li>
												<li class="py-2">Cookie instances can also be controlled programmatically.
									...
									<div class="pt-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">All Cookie components are initialized automatically, however the following are Cookie's API functionality methods for more control.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>Create a new Cookie with specified
															<code>name</code>,
															<code>value</code>and
															<code>options</code>
															<div class="pt-3">
...
<code class="language-javascript">var date = new Date(Date.now() + 2 * 24 * 60 * 60 * 1000); // +2 day from now
var options = { expires: date };
KTCookie.set("user_logged_in", "yes", options);</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Returns the selected cookie if applicable.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">KTCookie.get("user_logged_in");</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Destroys the selected cookie.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">KTCookie.remove("user_logged_in");</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
