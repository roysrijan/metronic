...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Offcanvas and Drawer Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/drawer.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Drawer
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Bootstrap Drawer is an exclusive plugin of Metronic that provides a simple, smooth and lightweight option for hidden sidebars that are most used for navigations, shopping carts and a whole lot more.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Bootstrap Drawer's global style and scripts bundles and are globally included in all pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Bootstrap Drawer's Javascript is globally initialized and added into our script bundle.</li>
												<li class="py-2">To initialize it, the drawer view component needs to be added within the page with a button trigger to toggle it.</li>
												<li class="py-2">Bootstrap Drawer instances can also be created programmatically.
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">There are 2 parts when adding in a drawer component. There's the trigger and the view component. The trigger can be anything with a specific
										<code>id</code>which needs to be defined in the view component.
										<br />
										<br />The view component will then have a few HTML attributes that will set it's configuration options. The key attributes are:
										<ul class="pt-3 pb-5">
											<li class="py-2">
										...
										<a href="#options" class="me-1" data-kt-scroll-toggle="">Click here</a>for more info on the options.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
...
<code class="language-html">&lt;!--begin::Trigger button--&gt;
&lt;button id="kt_drawer_example_basic_button" class="btn btn-primary"&gt;Toggle basic drawer&lt;/button&gt;
&lt;!--end::Trigger button--&gt;
...
&lt;!--end::View component--&gt;</code>
											...
											<div class="card-header pe-5">
												...
												<div class="card-title">
													...
													<div class="d-flex justify-content-center flex-column me-3">
														<a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 lh-1">Example Basic</a>
													</div>
													<!--end::User-->
												</div>
												<!--end::Title-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="advanced">
										<a href="#advanced" data-kt-scroll-toggle=""></a>Advanced Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Bootstrap Drawer component can be easily configured by adding additional HTML attributes to the view component. For example, adding
										<code>data-kt-drawer-direction</code>will indicate which side the drawer will slide out from (
										<code>start</code>for left and
										<code>end</code>for right).
										<br />
										<br />Adding
										<code>data-kt-drawer-width</code>will set the drawer view component's width and it's also very responsive and uses Bootstrap's default breakpoints to switch widths on certain screen sizes. For example:
										<code>{default:'300px', 'md': '500px'}</code>indicates that the drawer view component has
										<code>500px</code>width on screens larger than
										<code>md</code>and
										<code>300px</code>for every other screen size.
										<br />
										<br />
										<a href="#options" class="me-1" data-kt-scroll-toggle="">Click here</a>for more info on the options.</div>
										<!--end::Block-->
										...
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
												<!--begin::Button-->
												<button id="kt_drawer_example_advanced_button" class="btn btn-primary">Toggle advanced drawer</button>
												<!--end::Button-->
											</div>
										</div>
										<!--end::Block-->
...
&lt;!--end::View component--&gt;</code>
										...
										<div class="card rounded-0 w-100">
											...
											<div class="card-header pe-5">
												...
												<div class="card-title">
													<!--begin::User-->
													<div class="d-flex justify-content-center flex-column me-3">
														<a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 lh-1">Example Advanced</a>
													</div>
													<!--end::User-->
												</div>
												<!--end::Title-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="dismiss">
										<a href="#dismiss" data-kt-scroll-toggle=""></a>Adhoc Dismiss Button Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add a button or link within Bootstrap Drawer view component with the HTML attributes
										<code>data-kt-drawer-dismiss="true"</code>to close the current drawer.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
...
&lt;!--end::View component--&gt;</code>
										...
										<div class="card rounded-0 w-100">
											...
											<div class="card-header pe-5">
												...
												<div class="card-title">
													<!--begin::User-->
													<div class="d-flex justify-content-center flex-column me-3">
														<a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 lh-1">Example Dismiss Button</a>
													</div>
													<!--end::User-->
												</div>
												<!--end::Title-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="external">
										<a href="#external" data-kt-scroll-toggle=""></a>External Toggle Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Bootstrap Drawers can also be toggled without binding the button
										<code>id</code>with the drawer view component by adding
										<code>data-kt-drawer-show="true"</code>and
										<code>data-kt-drawer-target</code>with the drawer view component
										<code>id</code>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
												<!--begin::Button-->
												<button class="btn btn-primary me-3 my-1 my-lg-0" data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_example_basic">Toggle basic drawer</button>
												<button class="btn btn-primary my-1 my-lg-0" data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_example_advanced">Toggle advanced drawer</button>
												<!--end::Button-->
											</div>
										</div>
										<!--end::Block-->
...
&lt;!--end::Trigger button--&gt;</code>
									...
									<div class="py-10">
												...
												<table class="table table-striped align-top mb-0 g-5">
													...
													<tbody>
														<tr>
															...
															<td>Defines the element as a drawer view component.</td>
														</tr>
														<tr>
															<td>
																<code>data-kt-drawer-activate</code>
															...
															<td>
															<div class="mb-3">Enables the drawer view component. Accepts
															<code>true</code>and
															<code>false</code>values. Default value is set to
															<code>true</code>.</div>
															<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing
															<code>eg: sm, md, lg, xl</code>. For responsive options, this attribute value must be written as a JSON string to specify values for multiple responsive breakpoints.</div>For example:
															<code>{default: false, md: true}</code>indicates that the drawer is activated only when width on screens larger than
															<code>md</code>breakpoint size.</td>
														</tr>
														<tr>
															<td>
																<code>data-kt-drawer-toggle</code>
														...
														<tr>
															...
															<td>Defines the close button
															<code>id</code>within the drawer view component.</td>
														</tr>
														<tr>
															<td>
															...
															<td>Defines the drawer view component's name for identification and used to append a special attribute to Body element to indicate the drawer's shown state.</td>
														</tr>
														<tr>
															<td>
															...
															<td>Toggles the drawer view component as an overlay element or not. Accepts
															<code>true</code>and
														...
														<tr>
															...
															<td>
															<div class="mb-3">Specifies the drawer view component's width in either a
															<code>px</code>or
															<code>%</code>value. For example:
															<code>400px</code>or
															<code>25%</code></div>
															<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
															<code>sm, md, lg, xl</code>) with similar
															<code>px</code>or
															<code>%</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.</div>For example:
															<code>{default:'300px', 'md': '500px'}</code>indicates that the drawer view component has
															<code>500px</code>width on screens larger than
															<code>md</code>and
															<code>300px</code>for every other screen size.
														...
														<tr>
															...
															<td>Defines the starting direction for the drawer view component. Accepts
															<code>start</code>for left and
															<code>end</code>for right values. Default value is set to
															<code>end</code>.</td>
														</tr>
													</tbody>
												</table>
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">Please note that a drawer view component is a simple wrapper element that may contain all other components or elements within it. All HTML attributes should be added into the main wrapping element only.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">All Bootstrap Drawer components are initialized automatically, however the following are the Bootstrap Drawer's functionality methods for more control.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>Initializes Drawer instances by selector. Default value of
															<code>selector</code>is
															<code>[data-kt-drawer="true"]</code>. This method can be used to initialize dynamicly populated Drawer instances(e.g: after Ajax request).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">KTDrawer.createInstances();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Get the Drawer instance created
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">var drawerElement = document.querySelector("#kt_drawer_example_1");
var drawer = KTDrawer.getInstance(drawerElement);</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
													...
													<tbody>
														<tr>
															...
															<code>KTDrawer</code>class and initializes a Drawer control:
															<div class="pt-3 mb-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
var scroll = new KTDrawer(scrollElement, {overlay: true});</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<code>data-kt-drawer="true"</code>attribute to avoid lazy initialization. Option
																<code>overlay</code>replicates
																<code>data-kt-drawer-overlay</code>option functionaliy as described above.</div>
																<!--end::Description-->
															</div>
															<!--end::Information--></td>
														</tr>
														<tr>
															...
															<td>Toggle the drawer view component's state.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.toggle();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Show/open the drawer view component if the it's current closed. Does nothing if it's already opened.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.show();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Hide/close the drawer view component if the it's current opened. Does nothing if it's already closed.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.hide();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Return the drawer view component's display state. Returns
															<code>true</code>or
															<code>false</code>.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.isShown();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Forces the drawer component to update with any modifications done.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.update();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Returns the selected drawer instance.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.goElement();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<div class="pt-3">
																...
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">drawer.destroy();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
									...
									<div class="pt-10">
										...
										<a href="#events" data-kt-scroll-toggle=""></a>Events</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Below are few events for hooking into the Bootstrap Drawer functionality.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="pt-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>This event fires on when the drawer is about to get toggled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">var drawerEl = document.querySelector("#kt_drawer_example");
...
drawer.on("kt.drawer.toggle", function() {
    // console.log("kt.drawer.toggle event is fired");
														...
														<tr>
															...
															<td>This event fires on when the drawer is done toggling.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
drawer.on("kt.drawer.toggled", function() {
    // console.log("kt.drawer.toggled event is fired");
														...
														<tr>
															...
															<td>This event fires on when the drawer starts to hide.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
drawer.on("kt.drawer.hide", function() {
    // console.log("kt.drawer.hide event is fired");
														...
														<tr>
															...
															<td>This event fires on when the drawer is completely hidden.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
drawer.on("kt.drawer.after.hidden", function() {
    // console.log("kt.drawer.after.hidden event is fired");
														...
														<tr>
															...
															<td>This event fires on when the drawer starts to show.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
drawer.on("kt.drawer.show", function() {
    // console.log("kt.drawer.show event is fired");
														...
														<tr>
															...
															<td>This event fires on when the drawer is completely shown.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
drawer.on("kt.drawer.shown", function() {
    // console.log("kt.drawer.shown event is fired");
														...
														<tr>
															...
															<td>Triggers a specific event to the selected drawer.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">var drawerEl = document.querySelector("#kt_drawer_example");
var drawer = KTDrawer.getInstance(drawerEl);
drawer.trigger(drawer, "kt.drawer.show"); // trigger show drawer</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
		...
		<script src="assets/js/custom/documentation/general/drawer.js"></script>
