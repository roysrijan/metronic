...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Toggle Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/toggle.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Toggle
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Toggle's script bundles are globally included in all pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Toggle's Javascript is globally initialized and added into our script bundle.</li>
												<li class="py-2">Add
												<code>data-kt-toggle="true"</code>to a HTML element to enable it. There are multiple additional HTML attributes you can include to configure Toggle directly.</li>
												<li class="py-2">Toggle instances can also be controlled programmatically.
									...
									<div class="py-10">
										...
										<div class="py-5">
										<div class="mb-3">Add
										<code>data-kt-toggle="true"</code>to any element element to enable it. Then add the additional attributes to configure the toggle.</div>
										<div class="mb-3">Use the browser's inspect tool on the button below to preview the toggle in action.</div>
										...
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
												<!--begin::Toggle button-->
												<button id="kt_toggle_example_basic" class="btn btn-light-primary" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="#kt_toggle_example_target" data-kt-toggle-name="toggle-name">Click this button and inspect the below element</button>
												<!--end::Toggle button-->
												<!--begin::Toggle tagert-->
												<div class="bg-light rounded p-5 mt-10" id="kt_toggle_example_target">Toggle target</div>
												<!--end::Toggle tagert-->
											</div>
										</div>
										<!--end::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<div class="highlight-code">
													<pre class="language-html">
<code class="language-html">&lt;!--begin::Toggle button--&gt;
...
&lt;!--end::Toggle tagert--&gt;</code>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Toggle uses HTML attributes to define the toggle configuration. Here are the references for each below</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
												...
												<table class="table table-striped align-top mb-0 g-5">
													...
													<tbody>
														<tr>
															...
															<td>Enables the element as a toggle.</td>
														</tr>
														<tr>
															<td>
															...
															<td>A class to add into the toggle element. Accepts any string value. For example, if
															<code>data-kt-toggle-state="active"</code>is set, then the class
															<code>active</code>will be added or removed into the toggle element's class on click.</td>
														</tr>
														<tr>
															<td>
															...
															<td>Defines the custom HTML attrbute name that will be added into the target element defined in
															<code>data-kt-toggle-target</code>. Accepts a string value without spaces.</td>
														</tr>
														<tr>
															<td>
															...
															<td>
															<div class="mb-3">Defines the target element to add or remove a custom HTML attribute when Toggle is clicked. The custom HTML attribute is created by using the value added in
															<code>data-kt-toggle-name</code>. For example, if we add in
															<code>data-kt-toggle-name="docs-basic-example"</code>and
															<code>data-kt-toggle-target="#kt_toggle_example_basic"</code>, when the button is clicked,
															<code>data-kt-docs-basic-example="on"</code>will be added into the targeted element.</div>This additional HTML attribute can then be used for any custom Javascript hooks as required.</td>
														</tr>
													</tbody>
												</table>
											</div>
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">All Bootstrap Toggle components are initialized automatically, however the following are Toggle's functionality methods for more control.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>Initializes Bootstrap Toggle instances by selector. Default value of
															<code>selector</code>is
															<code>[data-kt-toggle="true"]</code>. This method can be used to initialize dynamicly populated Bootstrap Toggle instances(e.g: after Ajax request).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">KTToggle.createInstances();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<div class="pt-3">
																...
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">var toggleElement = document.querySelector("#kt_toggle_example_1");
var toggle = KTToggle.getInstance(toggleElement);</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
													...
													<tbody>
														<tr>
															...
															<td>Toggle the selected toggle element.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.toggle();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Set the toggle element to active or enabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.enable();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Set the toggle element to inactive or disabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.disable();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<td>Returns the toggle state as
															<code>true</code>or
															<code>false</code>
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.isEnabled();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<div class="pt-3">
																...
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.goElement();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
														...
														<tr>
															...
															<div class="pt-3">
																...
																<div class="highlight">
																	...
																	<div class="highlight-code">
																		<pre class="language-javascript">
<code class="language-javascript">toggle.destroy();</code>
</pre>
																	</div>
																</div>
																<!--end::Highlight-->
									...
									<div class="pt-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Below are few events for hooking into the Toggle functionality.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="pt-2">
											<!--begin::Table wrapper-->
												...
												<table class="table table-striped mb-0 g-6">
													...
													<tbody>
														<tr>
															...
															<td>This event fires on when the toggle element is about to get toggled (either enabled or disabled).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
toggle.on("kt.toggle.change", function() {
    // console.log("kt.toggle.change event is fired");
														...
														<tr>
															...
															<td>This event fires on when the toggle element has been toggled (either enabled or disabled).
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
toggle.on("kt.toggle.changed", function() {
    // console.log("kt.toggle.changed event is fired");
														...
														<tr>
															...
															<td>This event fires on when the toggle element is about to be enabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
toggle.on("kt.toggle.enable", function() {
    // console.log("kt.toggle.enable event is fired");
														...
														<tr>
															...
															<td>This event fires on when the toggle element has been enabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
toggle.on("kt.toggle.enabled", function() {
    // console.log("kt.toggle.enabled event is fired");
														...
														<tr>
															...
															<td>This event fires on when the toggle element is about to be disabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
toggle.on("kt.toggle.disable", function() {
    // console.log("kt.toggle.disable event is fired");
														...
														<tr>
															...
															<td>This event fires on when the toggle element has been disabled.
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
