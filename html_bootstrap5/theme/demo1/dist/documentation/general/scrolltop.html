					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/scrolltop.html">
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												...
												<code>data-kt-scrolltop="true"</code>to a HTML element to enable it.</li>
									...
									<div class="py-10">
										...
										<code>data-kt-scrolltop="true"</code>to any element element to enable it. However, it's best to be used with an icon as the child element.</div>
										<div class="mb-3">The
										<code>.scrolltop</code>css class adds all necessary styling to the scrolltop element. Adding additional Bootstrap classes to scrolltop will also work accordingly to override the default css styling.</div>
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary">
												...
												<code>data-kt-scrolltop="true"</code>only.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
												...
												<table class="table table-striped align-top mb-0 g-5">
													...
													<tbody>
														...
														<tr>
															...
															<code>data-kt-scrolltop-offset="300"</code>.</td>
														</tr>
														<tr>
															<td>
															...
															<code>data-kt-scrolltop-speed="600"</code>will define that it will take about 0.6 seconds to scroll to the top of the page when clicked.</td>
														</tr>
													</tbody>
												</table>
											</div>
...
var scrollTop = new KTScrolltop(scrollElement, {offset: 300, speed: 600});</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<code>data-kt-scrolltop-speed</code>options functionaliy as described above.</div>
																<!--end::Description-->
															</div>
															<!--end::Information--></td>
														</tr>
