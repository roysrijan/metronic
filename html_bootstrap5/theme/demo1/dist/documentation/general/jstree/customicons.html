							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/jstree/customicons.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Custom Icons</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
						...
						<div class="container" id="kt_docs_content_container">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="customicons">
										<a href="#customicons" data-kt-scroll-toggle=""></a>Custom Icons &amp; Clickable Nodes</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="mb-3">Here's a jsTree example with custom icons and clickable nodes. For more info, please visit the
											...
											<div id="kt_docs_jstree_customicons">
												<ul>
													...
													<ul>
														...
														<li data-jstree='{ "icon" : "flaticon2-analytics text-success " }'>custom icon URL</li>
														...
														<li data-jstree='{ "icon" : "flaticon2-user text-danger" }'>Custom icon class (bootstrap)</li>
													</ul></li>
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d4800e343e" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d4800e3445" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d4800e343e" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">$('#kt_docs_jstree_customicons').jstree({
    "core" : {
        "themes" : {
            "responsive": false
        }
...
$('#kt_docs_jstree_customicons').on('select_node.jstree', function(e,data) {
    ...
    if (link.attr("href") != "#" &amp;&amp; link.attr("href") != "javascript:;" &amp;&amp; link.attr("href") != "") {
        ...
        return false;
													...
													<div class="tab-pane fade" id="kt_highlight_610d4800e3445" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;div id="kt_docs_jstree_customicons"&gt;
    &lt;ul&gt;
        &lt;li&gt;
            Root node 1
            &lt;ul&gt;
...
&lt;/div&gt;</code>
		...
		<script src="assets/js/custom/documentation/general/jstree/customicons.js"></script>
