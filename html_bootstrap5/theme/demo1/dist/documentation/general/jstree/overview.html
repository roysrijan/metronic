						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/jstree/overview.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Overview</span>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">jsTree is jquery plugin, that provides interactive trees. For more info please visit the plugin's
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">jsTree's style and script bundles are separate from our global bundle and required to be included and initialized manually on related pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
<code class="language-html">&lt;link href="assets/plugins/custom/jstree/jstree.bundle.css" rel="stylesheet" type="text/css" /&gt;
&lt;script src="assets/plugins/custom/jstree/jstree.bundle.js"&gt;&lt;/script&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">jsTree's CSS and Javascript is required to be added into the page via the
												<a href="#usage" class="me-1" data-kt-scroll-toggle="">usage code</a>snippet above, along with our other global bundles.</li>
												<li class="py-2">Add a blank
												<code>div</code>with a unique
												<code>id</code>and initialize it with Javascript.</li>
												<li class="py-2">Alternatively, manually adding nodes via HTML will require
												<code>data-jstree</code>attribute to define the jsTree configuration. Please refer to our
												<a href="../../demo1/dist/documentation/general/jstree/basic.html" class="me-1">basic example</a>for a preview.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
