...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Draggable Restricted and Bootstrap Integration by Keenthemes</title>
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/draggable/restricted.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Restricted</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">Draggable</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item">
													<span class="bullet w-5px h-2px"></span>
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Restricted</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
										...
										<!--end::Icon-->
										<!--begin::Description-->
										<div class="text-gray-700 fw-bold fs-6 lh-lg">Draggable is a lightweight, responsive, modern drag &amp; drop library. Draggable abstracts native browser events into a comprehensive API to create a custom drag and drop experience. For more info see
										<a href="https://shopify.github.io/draggable/" class="fw-bolder me-1">the official site</a>and
										<a class="fw-bolder" href="https://github.com/Shopify/draggable">the Github repository</a>.</div>
										<!--end::Description-->
									</div>
									<!--end::Notice-->
									<!--begin::Section-->
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="restricted">
										<a href="#restricted" data-kt-scroll-toggle=""></a>Restricted Zones Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<ul>
												<li class="py-2">Wrap draggable zone with
												<code>.draggable-zone</code>and define draggable elements with
												<code>.draggable</code>and let drag &amp; drop through
												<code>.draggable-handle</code>element.</li>
												<li class="py-2">Add
												<code>data-kt-draggable-level="restricted"</code>to draggable zones to set a restricted permission level to the container.</li>
												<li class="py-2">Define draggable cards with permissions levels by adding
												<code>data-kt-draggable-level="admin"</code>to allow specific cards into the restricted container.</li>
												<li class="py-2">Restricted cards are allowed to drag into any column.</li>
												<li class="py-2">Restricted column will only allow restricted cards</li>
											</ul>
										</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">The HTML attribute is not an official attribute, and can be replaced with any other name according to your product requirements.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47fcd6d5b" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47fcd6d60" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47fcd6d5b" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var containers = document.querySelectorAll(".draggable-zone");
    ...
    if (isRestricted) {
        ...
        if (droppableOrigin !== "admin") {
            ...
            e.cancel();
													...
													<div class="tab-pane fade" id="kt_highlight_610d47fcd6d60" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;div class="row row-cols-lg-3 g-10"&gt;
    &lt;!--begin::Col--&gt;
    &lt;div class="col"&gt;
        &lt;!--begin::Card--&gt;
        &lt;div class="card card-bordered mb-10"&gt;
...
&lt;/div&gt;</code>
		...
		<script src="assets/js/custom/documentation/general/draggable/restricted.js"></script>
