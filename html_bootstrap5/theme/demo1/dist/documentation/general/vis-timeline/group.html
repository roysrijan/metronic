							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/vis-timeline/group.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">Vis-Timeline</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item">
													<span class="bullet w-5px h-2px"></span>
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Groups</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
										...
										<!--end::Icon-->
										<!--begin::Description-->
										<div class="text-gray-700 fw-bold fs-6 lh-lg">Vis-timeline is an interactive visualization chart to visualize data in time. For more info visit
										<a class="fw-bolder" href="https://github.com/visjs/vis-timeline">the Github repository</a>.</div>
										<!--end::Description-->
									</div>
									<!--end::Notice-->
									<!--begin::Section-->
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="group">
										<a href="#group" data-kt-scroll-toggle=""></a>Groups Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
										<div class="mb-3">Here's an example of Vis-timeline with groupped items. Click on the icon arrows to toggle sub-items.</div>For more info, please visit the
										<a href="https://github.com/visjs/vis-timeline" target="_blank">official website</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<button type="button" class="btn btn-primary mb-5" id="kt_docs_vistimeline_group_button">Show current visible items</button>
											<div class="mb-5">
											<div class="fw-bolder mb-5">Visible groups:
											<span id="visibleGroupsContainer" class="fw-normal"></span></div>(Scroll with the mouse and see the items being focus automatically on the timeline)</div>
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47fee045b" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47fee0462" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47fee045b" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var now = Date.now();
...
button.addEventListener('click', e =&gt; {
    ...
    document.getElementById("visibleGroupsContainer").innerHTML += a;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47fee0462" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;button type="button" class="btn btn-primary mb-5" id="kt_docs_vistimeline_group_button"&gt;Show current visible items&lt;/button&gt;
&lt;div class="mb-5"&gt;
...
&lt;div id="kt_docs_vistimeline_group"&gt;&lt;/div&gt;</code>
</pre>
														</div>
													</div>
												</div>
		...
		<script src="assets/js/custom/documentation/general/vis-timeline/group.js"></script>
