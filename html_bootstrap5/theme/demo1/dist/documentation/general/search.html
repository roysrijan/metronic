					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/search.html">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<b>Quick Search</b>&#160; hooks are globally included in our scripts bundle, however, initialization is manually controlled and is required to be included.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												...
												<a href="#options" data-kt-scroll-toggle="">See below for more info</a>.</li>
									...
									<div class="py-10">
										...
										<a href="#basic" data-kt-scroll-toggle=""></a>Basic Layout Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47f895532" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47f895538" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47f895532" role="tabpanel">
														<div class="highlight-code">
...
handleInput();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_610d47f895538" role="tabpanel">
														<div class="highlight-code">
...
&lt;!--end::Main wrapper--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#menu" data-kt-scroll-toggle=""></a>Menu Layout Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										...
										<div class="py-5">
											<div class="rounded border p-5 p-lg-15">
												<!--begin::Search-->
												<div id="kt_docs_search_handler_menu" class="d-flex align-items-stretch" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-overflow="false" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start" data-kt-menu-flip="bottom">
													<!--begin::Search toggle-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47f8992c6" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47f8992cb" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47f8992c6" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var processs = function(search) {
    var timeout = setTimeout(function() {
...
handleAdvancedOptionsForm();</code>
													...
													<div class="tab-pane fade" id="kt_highlight_610d47f8992cb" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Main wrapper--&gt;
&lt;div id="kt_docs_search_handler_menu"
...
&lt;!--end::Main wrapper--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#responsive" data-kt-scroll-toggle=""></a>Responsive Layout Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
															...
															<div data-kt-search-element="results" class="d-none">
																...
																<div class="scroll-y mh-200px mh-lg-300px my-2 me-n2 pe-2">
																	...
																	<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1" data-kt-search-category="projects">
																		...
																		<div class="symbol symbol-30px me-4">
																			<span class="symbol-label bg-light-primary">
																				<!--begin::Svg Icon | path: icons/duotone/Shopping/Wallet.svg-->
																				<span class="svg-icon svg-icon-2 svg-icon-primary">
																					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																							<rect x="0" y="0" width="24" height="24" />
																	...
																	<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1" data-kt-search-category="projects">
																		...
																		<div class="symbol symbol-30px me-4">
																			<span class="symbol-label bg-light-primary">
																				<!--begin::Svg Icon | path: icons/duotone/Home/Picture.svg-->
																				<span class="svg-icon svg-icon-2 svg-icon-primary">
																					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																							<polygon points="0 0 24 0 24 24 0 24" />
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47f89cf7f" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47f89cf86" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47f89cf7f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">var processs = function(search) {
    var timeout = setTimeout(function() {
...
preferencesDismissElement.addEventListener("click", function() {
    ...
    preferencesElement.classList.add("d-none");
													...
													<div class="tab-pane fade" id="kt_highlight_610d47f89cf86" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Main wrapper--&gt;
&lt;div
    ...
    &lt;div data-kt-search-element="toggle" class="d-flex d-lg-none align-items-center"&gt;
        &lt;div class="btn btn-icon btn-active-light-primary"&gt;
            &lt;?php echo Theme::getSvgIcon("icons/duotone/General/Search.svg", "svg-icon-1")?&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;!--end::Tablet and mobile search toggle--&gt;
    ...
    &lt;form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off"&gt;
        ...
        &lt;!--begin::Icon--&gt;
        &lt;?php echo Theme::getSvgIcon("icons/duotone/General/Search.svg", "svg-icon-2 svg-icon-lg-1 svg-icon-gray-500 position-absolute top-50 translate-middle-y ms-5")?&gt;
        &lt;!--end::Icon--&gt;
        ...
        &lt;!--begin::Reset--&gt;
        &lt;span class="btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 me-5 d-none" data-kt-search-element="clear"&gt;
            &lt;?php echo Theme::getSvgIcon("icons/duotone/Navigation/Close.svg", "svg-icon-2 svg-icon-lg-1 me-0")?&gt;
        &lt;/span&gt;
        &lt;!--end::Reset--&gt;
    &lt;/form&gt;
    &lt;!--end::Form--&gt;
...
&lt;!--end::Main wrapper--&gt;</code>
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">
										<b>Quick Search</b>&#160; uses HTML attributes within the Main Wrapper to configure the frontend logic. Here are the references for each below</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-5">
												...
												<table class="table table-striped align-top mb-0 g-5">
													...
													<tbody>
														...
														<tr>
															...
															<code>null</code>values.</div>For example:
															...
															<code>lg</code>screen sizes and above, and hidden (re-positioned into the dropdown menu) on smaller screens.</td>
														</tr>
														<tr>
															<td>
													...
													<tbody>
														<tr>
															...
															<td>
																...
																<code>div</code>element that wraps all Quick Search inner elements.</div>
