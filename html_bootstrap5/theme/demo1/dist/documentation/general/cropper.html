...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Cropper.js and Bootstrap Integration by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/cropper.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Cropper</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Cropper.js is a JavaScript image cropper. For more info see
										<a href="https://fengyuanchen.github.io/cropperjs/" class="fw-bolder me-1">the official site</a>and
										<a class="fw-bolder" href="https://github.com/fengyuanchen/cropperjs">the Github repository</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Cropper.js's style and script bundles are separate from our global bundle and required to be included and initialized manually on related pages.</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
<code class="language-html">&lt;link href="assets/plugins/custom/cropper/cropper.bundle.css" rel="stylesheet" type="text/css" /&gt;
&lt;script src="assets/plugins/custom/cropper/cropper.bundle.js"&gt;&lt;/script&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="py-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">Cropper.js's CSS and Javascript is required to be added into the page via the
												<a href="#usage" class="me-1" data-kt-scroll-toggle="">usage code</a>snippet above, along with our other global bundles.</li>
												<li class="py-2">Add the HTML template provided in our
												<a href="#basic" class="me-1" data-kt-scroll-toggle="">example</a>below.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
									...
									<div class="pt-10">
										...
										<a href="#basic" data-kt-scroll-toggle=""></a>Cropper.js Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Visit Cropper.js's
										<a href="https://fengyuanchen.github.io/cropperjs/" class="me-1">official website</a>for more examples.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="pt-5">
											<!--begin::Cropper-->
											<div class="row">
												...
												<div class="col-lg-4">
													<div class="cropper-preview clearfix d-flex flex-wrap mb-3">
														<div id="cropper-preview-lg" class="img-preview preview-lg w-100 img-fluid mb-3" style="width: 256px; height: 160px; overflow: hidden; background-color: #f7f7f7;"></div>
														...
														<div id="cropper-preview-sm" class="img-preview preview-sm float-left ms-3" style="width: 64px; height: 40px; overflow: hidden; background-color: #f7f7f7;"></div>
														<div id="cropper-preview-xs" class="img-preview preview-xs float-left ms-3" style="width: 32px; height: 20px; overflow: hidden; background-color: #f7f7f7;"></div>
													</div>
													<!-- <h3>Data:</h3> -->
													...
													<div class="btn-group d-flex flex-nowrap" id="toggleOptionButtons">
														<div class="dropdown" style="width: 100%;">
															<button class="btn btn-brand dropdown-toggle" style="width: 100%;" type="button" id="toggleOption" data-bs-toggle="dropdown">Toggle options</button>
		...
		<script src="assets/js/custom/documentation/general/cropper.js"></script>
