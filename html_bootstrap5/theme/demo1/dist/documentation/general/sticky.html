...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Custom Bootstrap Sticky Component by Keenthemes</title>
					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/sticky.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Sticky
									...
									<div class="d-flex flex-column flex-xl-row">
										...
										<div class="flex-lg-row-fluid me-lg-10">
											...
											<div class="pb-10">
												...
												<!--end::Heading-->
												<!--begin::Block-->
												<div class="py-5">Sticky is an exclusive plugin of Metronic that provides a simple, smooth and lightweight for initializing sticky components without any Javascript.</div>
												<!--end::Block-->
											</div>
											<!--end::Section-->
											<!--begin::Section-->
											<div class="py-10">
												...
												<!--end::Heading-->
												<!--begin::Block-->
												<div class="py-5">Sticky's script bundles are globally included and initialized in all pages.</div>
												<!--end::Block-->
												<!--begin::Code-->
												<div class="py-5">
													<!--begin::Highlight-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
											...
											<div class="py-10">
												...
												<div class="py-5">
													<ul class="py-0">
														<li class="py-2">Sticky's Javascript is globally initialized and added into our script bundle.</li>
														<li class="py-2">Add
														<code>data-kt-sticky="true"</code>to a HTML element to enable it. There are multiple additional HTML attributes you can include to configure Sticky directly.</li>
														<li class="py-2">Sticky is a wrapping element, therefore, by itself it doesn't do much. However, adding multiple HTML components into sticky's container will allow all contained HTML components to be sticky on browser scroll.</li>
														<li class="py-2">Sticky instances can also be controlled programmatically.
											...
											<div class="py-10">
												...
												<!--begin::Block-->
												<div class="py-5">
													<div class="mb-3">The example sticky component is previewed on the right side of the screen. There are a variety HTML attributes added in the
													<code>div</code>wrapper (in this example, our wrapper element is a
													<code>.card</code>), please refer to the
													<a href="#options" class="me-1" data-kt-scroll-toggle="">markup reference</a>below to view what each of them do.</div>
												</div>
												<!--end::Block-->
												<!--begin::Notice-->
												<div class="py-5">
													...
													<div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary">
														...
														<!--end::Icon-->
														<!--begin::Description-->
														<div class="text-gray-700 fw-bold fs-6">A sticky component is a simple wrapper element. Anything that gets added into a sticky component will also be sticky.</div>
														<!--end::Description-->
													</div>
													<!--end::Information-->
												</div>
												...
												<div class="py-5">
													...
													<div class="highlight">
														...
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-flush bg-light mb-0"
    data-kt-sticky="true"
...
&lt;/div&gt;</code>
											...
											<div class="py-10">
												...
												<!--end::Heading-->
												<!--begin::Block-->
												<div class="py-5">Sticky uses HTML attributes to define the certain configurations. Here are the references for each below</div>
												<!--end::Block-->
												<!--begin::Block-->
												<div class="py-5">
														...
														<table class="table table-striped align-top mb-0 g-5">
															...
															<tbody>
																<tr>
																	...
																	<td>Defines the element as a drawer view component. Accepts
																	<code>true</code>or
																...
																<tr>
																	...
																	<td>Defines the sticky component's name for identification and used to append a special attribute to Body element to indicate the sticky's on scroll state.</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>
																	<div class="mb-3">Specifies the sticky component's offset value from the top for when it toggles from a regular state to a sticky state. Accepts
																	<code>px</code>value. For example:
																	<code>50px</code>.</div>
																	<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																	<code>sm, md, lg, xl</code>) with a similar
																	<code>px</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.</div>For example:
																	<code>{default:'30px', 'md': '50px'}</code>indicates that the sticky component will stick on screen when
																	<code>50px</code>from the top is scrolled on screens larger than
																	<code>md</code>and
																	<code>30px</code>form the top for every other screen size.
																	<br /></td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>Resets the sticky element back to it's original state when user starts rever scrolling. Accepts
																	<code>true</code>or
																...
																<tr>
																	...
																	<td>
																	<div class="mb-3">Specifies the sticky component's width in a
																	<code>px</code>value. For example:
																	<code>400px</code>.</div>
																	<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																	<code>sm, md, lg, xl</code>) with a similar
																	<code>px</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.</div>For example:
																	<code>{default:'300px', 'md': '500px'}</code>indicates that the sticky component has
																...
																<tr>
																	...
																	<td>
																	<div class="mb-3">Specifies the sticky component's left position from the parent container in either a
																	<code>px</code>value or
																	<code>auto</code>. For example:
																	<code>100px</code>.</div>
																	<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																	<code>sm, md, lg, xl</code>) with a similar
																	<code>px</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.</div>For example:
																	<code>{default:'auto', 'md': '50px'}</code>indicates that the sticky component has a left position of
																	<code>50px</code>on screens larger than
																	<code>md</code>and is
																	<code>auto</code>for every other screen size.</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>
																	<div class="mb-3">Specifies the sticky component's top position from the parent container in either a
																	<code>px</code>value or
																	<code>auto</code>. For example:
																	<code>100px</code>.</div>
																	<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																	<code>sm, md, lg, xl</code>) with a similar
																	<code>px</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.</div>For example:
																	<code>{default:'auto', 'md': '50px'}</code>indicates that the sticky component has a top position of
																	<code>50px</code>on screens larger than
																	<code>md</code>and is
																	<code>auto</code>for every other screen size.</td>
																</tr>
																<tr>
																	...
																	<td>Toggles the sticky component's animation introduction. Suitable to be enabled when the sticky component is required to slide into position when transitioning from a regular state to a sticky state.</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>Toggles the sticky component's
																	<code>z-index</code>value. Accepts a
																	<code>number</code>value.</td>
																</tr>
															</tbody>
														</table>
													</div>
											...
											<div class="py-10">
												...
												<!--end::Heading-->
												<!--begin::Block-->
												<div class="py-5">All sticky components are initialized automatically, however the following are Sticky's functionality methods for more control.</div>
												<!--end::Block-->
												<!--begin::Table-->
												<div class="py-2">
													<!--begin::Table wrapper-->
														...
														<table class="table table-striped mb-0 g-6">
															...
															<tbody>
																<tr>
																	...
																	<code>KTSticky</code>class and initializes a Sticky control:
																	<div class="pt-3 mb-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">var stickyElement = document.querySelector("#kt_sticky_control");
var sticky = new KTSticky(stickyElement);</code>
</pre>
																			</div>
																		</div>
																		<!--end::Highlight-->
																	...
																	<div class="d-flex align-items-center rounded py-5 px-5 bg-light-success">
																		...
																		<code>data-kt-sticky="true"</code>attribute to avoid lazy initialization.</div>
																		<!--end::Description-->
																	</div>
																	<!--end::Information--></td>
																</tr>
																<tr>
																	...
																	<td>Initializes Sticky instances by selector. Default value of
																	<code>selector</code>is
																	<code>[data-kt-sticky="true"]</code>. This method can be used to initialize dynamicly populated Sticky instances(e.g: after Ajax request).
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																			<div class="highlight-code">
																				<pre class="language-javascript">
<code class="language-javascript">KTSticky.createInstances();</code>
</pre>
																			</div>
																		</div>
																		<!--end::Highlight-->
																...
																<tr>
																	...
																	<td>Get the Sticky instance created
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																			<div class="highlight-code">
																				<pre class="language-javascript">
<code class="language-javascript">var stickyElement = document.querySelector("#kt_sticky_example_1");
var sticky = KTSticky.getInstance(stickyElement);</code>
</pre>
																			</div>
																		</div>
																		<!--end::Highlight-->
															...
															<tbody>
																<tr>
																	...
																	<td>Forces the sticky component to update with any modifications done.
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
																			<div class="highlight-code">
																				<pre class="language-javascript">
<code class="language-javascript">sticky.update();</code>
</pre>
																			</div>
																		</div>
																		<!--end::Highlight-->
											...
											<div class="pt-10">
												...
												<!--end::Heading-->
												<!--begin::Block-->
												<div class="py-5">Below are few events for hooking into the Sticky functionality.</div>
												<!--end::Block-->
												<!--begin::Table-->
												<div class="pt-2">
													<!--begin::Table wrapper-->
														...
														<table class="table table-striped mb-0 g-6">
															...
															<tbody>
																<tr>
																	...
																	<td>This event fires on when sticky is enabled from a regular state to a sticky state.
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
sticky.on("kt.sticky.on", function() {
    // console.log("kt.sticky.on event is fired");
																...
																<tr>
																	...
																	<td>This event fires on when sticky is disnabled from a sticky state to a regular state.
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
sticky.on("kt.sticky.off", function() {
    // console.log("kt.sticky.off event is fired");
																...
																<tr>
																	...
																	<td>This event fires on when sticky is changed from either a regular state to a sticky state or vice versa.
																	<div class="pt-3">
																		<!--begin::Highlight-->
																		<div class="highlight">
																			<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
sticky.on("kt.sticky.change", function() {
    // console.log("kt.sticky.change event is fired");
										...
										<div class="flex-column flex-lg-row-auto w-100 w-xl-300px pt-10 mb-10">
											<!--begin::Card-->
											<div class="card card-flush bg-light mb-0" data-kt-sticky="true" data-kt-sticky-name="docs-sticky-summary" data-kt-sticky-offset="{default: false, xl: '50px'}" data-kt-sticky-width="{lg: '250px', xl: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="100px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
												<!--begin::Card header-->
												<div class="card-header">
													...
													<div class="card-toolbar">
														<!--begin::More options-->
														<a href="#" class="btn btn-sm btn-light btn-icon" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
