						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/general/datatables/overview.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Overview</span>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Add advanced interaction controls to your HTML tables the free &amp; easy way. For more info see
										<a href="https://datatables.net/" class="fw-bolder me-1">the official site</a>and
										<a class="fw-bolder" href="https://github.com/DataTables/DataTables">the Github repository</a>.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">DataTables's CSS and Javascript files are bundled in a custom files and included on demand as shown below:</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
<code class="language-html">&lt;link href="assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css"/&gt;
&lt;script src="assets/plugins/custom/datatables/datatables.bundle.js"&gt;&lt;/script&gt;</code>
</pre>
												</div>
											</div>
											<!--end::Highlight-->
									...
									<div class="pt-10">
										...
										<div class="py-5">
											<ul class="py-0">
												<li class="py-2">DataTables's CSS is highly customized in
												<code>sass/vendors/plugins/_datatables.scss</code>SCSS file in order to use it as a native component within the design system. The SCSS code is compiled into
												<code>assets/plugins/global/plugins.bundle.css</code>and globally included in all pages.</li>
												<li class="py-2">DataTable's global settings are configured in
												<code>src/js/vendors/plugins/datatables.init.js</code>and this initialization code is bundled within
												<code>assets/plugins/custom/datatables/datatables.bundle.js</code>.</li>
											</ul>
										</div>
										<!--end::Block-->
									</div>
