									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">Server Side Integration</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item">
													<span class="bullet w-5px h-2px"></span>
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Laravel</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="pt-5">This documentation manual will explain how to implement Keenthemes designed admin dashboard theme
										<b>Metronic</b>&#160; in Laravel application. This article provided assuming you have a commom knowledge/understanding of
										<b>Metronic</b>, Laravel and Webpack.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="requirements">
										<a href="#requirements"></a>Requirements</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-0 m-0">
											<ol>
												<li class="py-3">
												<a class="fw-bold" href="https://www.php.net/">PHP</a>.</li>
												<li class="py-3">
												<a class="fw-bold" href="https://getcomposer.org/">Composer</a>&#160;- a Dependency Manager for PHP.</li>
												<li class="py-3">Install
												<b>Node.js</b>,
												<b>NPM</b>,
												<b>Yarn</b>,
												<b>Webpack</b>&#160;dependencies as explained in
												<a href="" class="fw-bold">Webpack Quick Start</a>.</li>
											</ol>
										</div>
										<!--end::Block-->
									</div>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="create-app">
										<a href="#create-blazor-app"></a>Create Laravel Application</h1>
										<!--end::Heading-->
										<!--begin::List-->
										<ol class="py-0 m-0">
											<li class="py-3">In your terminal, run the following command to create your
											<b>Laravel</b>&#160; app:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
...
<code class="language-bash">composer create-project --prefer-dist laravel/laravel laravel</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
											</div></li>
											<li class="py-3">This command creates your new
											<b>Laravel</b>&#160; app project and places it in a new directory called
											<code>laravel</code>inside your current location. Navigate into the newly created
											<code>laravel</code>directory by the following command:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
													<div class="highlight-code">
														<pre class="language-bash">
<code class="language-bash">cd laravel</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="preparing_theme_assets">
										<a href="#preparing_theme_assets"></a>Preparing Theme Assets</h1>
										<!--end::Heading-->
										<ol>
											<!--begin::Block-->
											<li class="py-3">Copy source folder from
											<code>theme/src</code>and paste it into
											<code>laravel/resources</code>.</li>
											<!--end::Block-->
											<li class="py-3">
												<div class="pb-3">In Metronic some plugins and components pages are located inside
												<code>tools/webpack</code>folder, so we need to move them into the same src folder in laravel project.</div>
												<div class="pt-3">Copy
												<code>tools/webpack</code>folder and paste it into
												<code>laravel/resources/src</code>.</div>
											</li>
										</ol>
									</div>
									<!--end::Section-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="fix_style_import_paths">
										<a href="#fix_style_import_paths"></a>Fix Style Import Paths</h1>
										<!--end::Heading-->
										<ol>
											<li>
												<!--begin::Block-->
												<div class="py-3">Since Metronic theme use
												<code>node_modules</code>folder which is located inside
												<code>tools</code>, but in laravel app we will use a root
												<code>node_modules</code>.</div>
												<!--end::Block-->
												<!--begin::Block-->
												<div class="py-3">Inside file
												<code>laravel/resources/src/sass/components/components.scss</code>we need to update import path and change
												<code>../../../../tools/node_modules/</code>to
												<code>~</code>which is alias for
												<code>node_modules</code>folder.</div>
												<!--end::Block-->
											</li>
										</ol>
									</div>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="preparing_theme_dependencies">
										<a href="#preparing_theme_dependencies"></a>Preparing Theme Dependencies</h1>
										<!--end::Heading-->
										<ol>
											<!--begin::Block-->
											<li class="py-3">To prepare theme dependencies we can just copy devDependencies and dependencies sections from
											<code>theme/tools/package.json</code>and paste them into
											<code>laravel/package.json</code>.</li>
											<!--end::Block-->
											<div class="py-3">
												<!--begin::Highlight-->
												<div class="highlight">
        ...
        "yarn-install": "^1.0.0"
											...
											<div class="py-3">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
													...
													<!--end::Icon-->
													<!--begin::Description-->
													<div class="text-gray-700 fw-bold fs-6">Remove default package-lock.json file first from laravel's root directory before the next step.</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
											</div>
											<li class="py-3">Now we can fetch the dependencies. Run this command in Laravel application root (where
											<code>package.json</code>is placed)</li>
											<div class="py-3">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-bash">npm install</code>
									...
									<div class="pb-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="preparing_mix_config">
										<a href="#preparing_mix_config"></a>Preparing Mix Config</h1>
										<!--end::Heading-->
										<ol>
											<li>
												<!--begin::Block-->
												<div class="py-3">Find and open
												<code>laravel/webpack.mix.js</code>file. Copy and paste below code.
												<div class="py-5">
													<!--begin::Highlight-->
													<div class="highlight">
														<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
mix.sass('resources/src/sass/style.scss', 'public/css/style.bundle.css', {
    ...
    .js('resources/plugins/scripts.js', 'public/js/scripts.bundle.js');
...
// ], 'public/plugins/custom/fullcalendar/fullcalendar.bundle.css');</code>
</pre>
														</div>
													</div>
													<!--end::Highlight-->
												...
												<div class="py-3">
													...
													<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
														...
														<!--end::Icon-->
														<!--begin::Description-->
														<div class="text-gray-700 fw-bold fs-6">This webpack.mix.js configuration file will bundle all source files which theme is requiring. Bundled files will be placed into
														<code>laravel/public</code>folder.</div>
														<!--end::Description-->
													</div>
													<!--end::Information-->
												</div>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="compile_assets">
										<a href="#compile_assets"></a>Compile Assets</h1>
										<!--end::Heading-->
										<ol>
											<li>
												<!--begin::Block-->
												<div class="pt-5">Run the following command to compile source files.</div>
												<!--end::Block-->
												<div class="py-5">
													<!--begin::Highlight-->
													<div class="highlight">
...
<code class="language-bash">npm run dev</code>
												...
												<div class="pt-5">We now can implement Metronic theme layout into Laravel application and include scripts/styles we have compiled.</div>
											</li>
										</ol>
									</div>
									<!--end::Section-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="sample_page">
										<a href="#sample_page"></a>Sample Page</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="pt-5">For the sample page you can use
										<code>dist/index.html</code>code or
										<a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" target="_blank">Layout Builder</a>&#160;to export the layout's HTML code and paste it into
										<code>laravel/resources/views/welcome.blade.php</code></div>
										<!--end::Block-->
										<div class="pt-5">
											<!--begin::Information-->
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<!--end::Icon-->
												<!--begin::Description-->
												<div class="text-gray-700 fw-bold fs-6">The Layout builder allows you to export the layout HTML code with structure partials that can be organized in separate folder with your Laravel views folder and included as partials within your layout view.</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
										</div>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="run-application">
										<a href="#overview"></a>Run Application:</h1>
										<!--end::Heading-->
										<!--begin::List-->
										<ol class="py-0 m-0">
											<li class="py-3">In your terminal, run the following command:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-bash">php artisan serve</code>
											...
											<li class="py-3">Wait for the app to display that it's listening on
											<a href="http://127.0.0.1:8000">http://127.0.0.1:8000</a>&#160; and open this url in your browser.</li>
										</ol>
										<!--end::List-->
									</div>
									<!--end::Section-->
