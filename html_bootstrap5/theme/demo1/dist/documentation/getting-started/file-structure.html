					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/file-structure.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">File Structure</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Metronic comes with a flexible file structure that can be easily used for small to large scope projects. This section will explain the entire file structure and how to adapt it to your project.</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="pt-5">
												...
												<table class="table table-striped table-flush align-middle mb-0">
													...
													<tbody>
														<tr class="p-6">
															...
															<td>The theme's Figma design files.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>theme</code>
														...
														<tr class="p-6">
															...
															<td>The
															<code>demo1</code>theme folder.</td>
														</tr>
														<tr class="p-6">
															<td class="ps-20">
																<code>dist</code>
															</td>
															<td>The destination folder that contains of the html templates and compiled assets.</td>
														</tr>
														<tr class="p-6">
															<td class="ps-20">
																<code>src</code>
															</td>
															<td>The source folder that contains of the SCSS, Javascript and media files. Required only for development and can be excluded for production.</td>
														</tr>
														<tr class="p-6">
															<td class="ps-13">
																<code>demo2</code>
														...
														<tr class="p-6">
															...
															<td>The theme build tools for command line assets compilation tasks. Required only for development and can be excluded for production.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>README.md</code>
															</td>
															<td>A tiny help file that privides a quick guide to get started with Metronic.</td>
														</tr>
													</tbody>
													<!--end::Block-->
												</table>
