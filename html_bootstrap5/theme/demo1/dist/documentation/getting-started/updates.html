					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/updates.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Updates</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-0">
										...
										<a href="#overview"></a>Updating &#160;Metronic</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-4">Like all HTML templates, you will need to manually handle all updates that we provide after purchase for free. The best practice is to always keep Metronic's source folder on an entire separate folder within your project and then use Metronic as a development companion or support.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-4">Each update should be used independently without mixing it with the previous versions. This is because new updates may not have a 100% backward compatibility for elements within previous versions. Therefore, each update is considered as a new and better version of the theme.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="pt-4">Here's our recommended steps needed to update Metronic effectively:
										<ol class="py-3">
											<li class="py-2">Backup all your files (your project folder and Metronic's's older version).</li>
											<li class="py-2">Review Metronics changelog to have a quick preview on what has been updated.</li>
											<li class="py-2">Unzip the latest version of Metronic and then browse through the elements (layout, widgets, plugins, etc) that you have used on your project.</li>
											<li class="py-2">Get the latest version use it instead the previous version.</li>
											<li class="py-2">Manually replace the
											<code>src</code>folder.</li>
											<li class="py-2">Run
											<code>yarn install</code>task to update 3rd party plugins with their latest versions.</li>
											<li class="py-2">Compare your project's code vs the latest version of Metronics code.</li>
											<li class="py-2">Manually update the HTML code where necessary by using code compare tools.</li>
											<li class="py-2">Save and test your project files with Metronic's updated elements.</li>
										</ol>If something goes wrong, you can revert your updates by reusing your backup files.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
								</div>
