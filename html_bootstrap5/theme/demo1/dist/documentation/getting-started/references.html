					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/references.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">References</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="p-0">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Metronic uses the following open source resources:</div>
										<!--begin::Table-->
										<div class="py-5">
											<div class="table-responsive border rounded">
												<table class="table table-striped table-flush align-middle mb-0">
													...
													<tbody>
														...
														<tr class="p-6">
															<td>
																<code>bootstrap-multiselectsplitter</code>
															</td>
															<td>
																<a href="https://github.com/poolerMF/bootstrap-multiselectsplitter/" target="_blank">https://github.com/poolerMF/bootstrap-multiselectsplitter/</a>
															</td>
															<td>v1.0.4</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>@amcharts/amcharts4</code>
															</td>
															<td>
																<a href="https://www.amcharts.com/" target="_blank">https://www.amcharts.com/</a>
															</td>
															<td>v4.10.20</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>@ckeditor/ckeditor5-build-inline</code>
															</td>
															<td>
																<a href="https://ckeditor.com/ckeditor-5" target="_blank">https://ckeditor.com/ckeditor-5</a>
															</td>
															<td>v23.1.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="https://opencollective.com/popperjs" target="_blank">https://opencollective.com/popperjs</a>
															</td>
															<td>v2.9.3</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>@shopify/draggable</code>
															</td>
															<td>
																<a href="https://github.com/Shopify/draggable#readme" target="_blank">https://github.com/Shopify/draggable#readme</a>
															</td>
															<td>v1.0.0-beta.8</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>@yaireo/tagify</code>
															</td>
															<td>
																<a href="https://github.com/yairEO/tagify" target="_blank">https://github.com/yairEO/tagify</a>
															</td>
															<td>v4.4.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>bootstrap-daterangepicker</code>
															</td>
															<td>
																<a href="https://github.com/dangrossman/daterangepicker" target="_blank">https://github.com/dangrossman/daterangepicker</a>
															</td>
															<td>v3.1.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="https://github.com/chalk/chalk?sponsor=1" target="_blank">https://github.com/chalk/chalk?sponsor=1</a>
															</td>
															<td>v4.1.1</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="https://fengyuanchen.github.io/cropperjs" target="_blank">https://fengyuanchen.github.io/cropperjs</a>
															</td>
															<td>v1.5.12</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>datatables.net-select-bs5</code>
															</td>
															<td>
														...
														<tr class="p-6">
															<td>
																<code>datatables.net-datetime</code>
															</td>
															<td>
																<a href="https://github.com/DataTables/DateTime#readme" target="_blank">https://github.com/DataTables/DateTime#readme</a>
															</td>
															<td>v1.1.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>es6-promise</code>
															</td>
															<td>
																<a href="https://github.com/stefanpenner/es6-promise" target="_blank">https://github.com/stefanpenner/es6-promise</a>
															</td>
															<td>v4.2.8</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>es6-promise-polyfill</code>
															</td>
															<td>
																<a href="https://github.com/lahmatiy/es6-promise-polyfill/issues" target="_blank">https://github.com/lahmatiy/es6-promise-polyfill/issues</a>
															</td>
															<td>v1.2.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>esri-leaflet</code>
															</td>
															<td>
																<a href="http://esri.github.io/esri-leaflet" target="_blank">http://esri.github.io/esri-leaflet</a>
															</td>
															<td>v3.0.2</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>esri-leaflet-geocoder</code>
															</td>
															<td>
																<a href="https://github.com/Esri/esri-leaflet-geocoder" target="_blank">https://github.com/Esri/esri-leaflet-geocoder</a>
															</td>
															<td>v3.0.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="http://www.riccardotartaglia.it/jkanban" target="_blank">http://www.riccardotartaglia.it/jkanban</a>
															</td>
															<td>v1.3.1</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="http://jstree.com" target="_blank">http://jstree.com</a>
															</td>
															<td>v3.3.11</td>
														</tr>
														<tr class="p-6">
															...
															<td>
																<a href="httpshttps://github.com/Stuk/jszip" target="_blank">httpshttps://github.com/Stuk/jszip</a>
															</td>
															<td>v3.6.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>line-awesome</code>
															</td>
															<td>
																<a href="https://github.com/icons8/line-awesome" target="_blank">https://github.com/icons8/line-awesome</a>
															</td>
															<td>v1.3.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>nouislider</code>
															</td>
															<td>
																<a href="https://github.com/leongersen/noUiSlider" target="_blank">https://github.com/leongersen/noUiSlider</a>
															</td>
															<td>v15.2.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="http://pdfmake.org" target="_blank">http://pdfmake.org</a>
															</td>
															<td>v0.2.0</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															...
															<td>
																<a href="httpshttps://github.com/PrismJS/prism" target="_blank">httpshttps://github.com/PrismJS/prism</a>
															</td>
															<td>v1.24.1</td>
														</tr>
														<tr class="p-6">
														...
														<tr class="p-6">
															<td>
																<code>tiny-slider</code>
															</td>
															<td>
																<a href="https://github.com/ganlanyuan/tiny-slider#readme" target="_blank">https://github.com/ganlanyuan/tiny-slider#readme</a>
															</td>
															<td>v2.9.3</td>
														</tr>
														<tr class="p-6">
															...
															<td>
																<a href="httpshttps://github.com/tinymce/tinymce-dist" target="_blank">httpshttps://github.com/tinymce/tinymce-dist</a>
															</td>
															<td>v5.8.2</td>
														</tr>
														<tr class="p-6">
															...
															<td>
																<a href="http://www.toastrjs.com" target="_blank">http://www.toastrjs.com</a>
															</td>
															<td>v2.1.4</td>
														</tr>
														<tr class="p-6">
															...
															<td>
																<a href="https://github.com/mattboldt/typed.js" target="_blank">https://github.com/mattboldt/typed.js</a>
															</td>
															<td>v2.0.12</td>
														</tr>
														<tr class="p-6">
															...
															<td>
																<a href="https://visjs.github.io/vis-timeline/" target="_blank">https://visjs.github.io/vis-timeline/</a>
															</td>
															<td>v7.4.9</td>
														</tr>
														<tr class="p-6">
