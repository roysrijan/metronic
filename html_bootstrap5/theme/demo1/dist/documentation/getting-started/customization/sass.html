						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/customization/sass.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-600">Customization</li>
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item">
													<span class="bullet w-5px h-2px"></span>
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">SASS</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="pt-5">Metronic uses
										<a class="fw-bold" href="https://sass-lang.com/">SASS</a>&#160;, the most powerful CSS preprocessor for handling the theme css efficiently. Sass is the most mature, stable, and powerful professional grade CSS extension language in the world.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#components"></a>Components</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Components folder in
										<code>/src/sass/components/</code>contains SASS code that customizes the core Bootstrap components to match the
										<strong>Metronic</strong>'s own design system and custom components. Both Metronic and
									...
									<div class="py-10">
										...
										<a href="#bootstrap-variables"></a>Bootstrap Variables</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">In
										<code>/src/sass/_variables.scss</code>file, Metronic deeply customizes the standard
										<strong>Bootstrap</strong>&#160; components by following the best practices explained in
										<a class="fw-bold" href="https://getbootstrap.com/docs/4.5/getting-started/theming/">the official documentation</a>.</div>
										<!--end::Block-->
										<div class="pt-2 pb-5">
											<!--begin::Information-->
									...
									<div class="py-10">
										...
										<a href="#override-variables"></a>Override Variables</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">If you like to change the Bootstrap theme colors, border radiuses, font family and other variables, we suggest using
										<code>_variables.custom.scss</code>file so you keep your own changes separated from future updates to avoid conflicts. All variables to override in this file should be set without the
										<code>!default</code>attribute to prioritize your code change.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<a href="#layout"></a>Layout</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Layout related SASS code is located in
										<code>/src/sass/layout/</code>folder. This folder contains the layout's markup and SASS variables files as explained in the below table:</div>
										<!--end::Block-->
										<!--begin::Table-->
										<div class="py-5">
												...
												<table class="table table-striped table-flush align-middle mb-0">
													...
													<tbody>
														<tr class="p-6">
															...
															<td>Variables used by Layout Partials. You can easily change Aside width, header height and other common properties.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>_layout.scss</code>
															</td>
															<td>Defines main layout and its dependencies.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>_main.scss</code>
															</td>
															<td>Defines base markup and styles.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>_header.scss</code>
															</td>
															<td>Defines base layout markup and styles.</td>
														</tr>
														<tr class="p-6">
															<td>
																<code>_footer.scss</code>
															</td>
															<td>Defines footer markup and styles.</td>
														</tr>
													</tbody>
													<!--end::Block-->
												</table>
									...
									<div class="pt-10">
										...
										<a href="#compilation"></a>Compilation</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<ul class="pt-5">
											<li class="py-3">Metronic compiles layout, components(including the Bootstrap &amp; custom components) into the main bundle:
											<code>dist/assets/css/style.bundle.css</code>.</li>
											<li class="py-3">The custom SASS files are compiled separately into CSS folder:
											<code>dist/assets/css/custom</code></li>
											<li class="py-3">All 3rd-party plugins css files are bundled into the plugins bundle CSS file and globally included in all pages.
											<code>dist/assets/plugins/global/plugins.bundle.css</code>.</li>
										</ul>
										<!--end::Block-->
									</div>
									<!--end::Section-->
