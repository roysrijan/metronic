							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/customization/javascript.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Javascript</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The components folder in
										<code>src/js/components</code>contains Metronic exclusive components written in Javascript without any jQuery dependency. All components can be used by Angular, React and Vue versions.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="py-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">The layout folder in
										<code>src/js/layout/</code>contains Javascript files that handle the Layout partials(Aside, Header, Footer, Subheader, etc).</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pt-10">
										...
										<!--begin::Block-->
										<ul class="pt-5">
											<li class="py-3">Metronic compiles layout, components(including the Bootstrap &amp; custom components) Javascript code into the main bundle:
											<code>dist/assets/js/scripts.bundle.js</code>.</li>
											<li class="py-3">The custom Javascript code is compiled separately into CSS folder:
											<code>dist/assets/js/custom</code></li>
											<li class="py-3">All 3rd-party plugins Javascript code are bundled into the plugins Javascript bundle file and globally included in all pages.
											<code>dist/assets/plugins/global/plugins.bundle.js`</code>.</li>
										</ul>
										<!--end::Block-->
									</div>
									<!--end::Section-->
