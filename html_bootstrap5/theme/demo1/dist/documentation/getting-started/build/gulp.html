							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/build/gulp.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Gulp</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
										...
										<a class="fw-bold me-1" href="https://gulpjs.com/" target="_blank">Gulp</a>build tools provide easy package management and production deployment for any type of web application that also comes with powerful asset bundle tools to organize assets structure with custom bundling for production.</div>
										<!--end::Description-->
									</div>
									<!--end::Notice-->
									<!--begin::Section-->
...
<code class="language-bash">gulp --demo1</code>
											...
											<div class="py-5">
												...
												<div class="highlight">
													...
													<div class="highlight-code">
														<pre class="language-bash">
<code class="language-bash">gulp localhost --demo1</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Gulp Build Options</h1>
										<!--end::Heading-->
										<!--begin::Block-->
                ...
                "media": "{$config.dist}/api/"
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<h4 class="text-dark fs-4 mb-2 fw-bolder">Required Core CSS and JS files</h4>The core CSS and JS files defined under
										...
										<div class="py-5">
											<div class="table-responsive border rounded">
												<table class="table table-striped table-borderless align-middle mb-0">
													...
													<thead>
														<tr>
															<th class="fs-4 fw-bolder text-dark ps-6 py-6" colspan="3">Gulp Build Options</th>
														</tr>
													</thead>
													<tbody>
														<tr class="text-gray-600 align-middle">
															<th class="fw-bold ps-6 py-6" scope="col">Field</th>
															<th class="fw-bold text-gray-600 py-6" scope="col">Type</th>
															<th class="fw-bold text-gray-600 ps-6 py-6" scope="col">Description</th>
														</tr>
														<tr>
															<td class="py-6 ps-6">
													...
													<thead>
														<tr>
															<th class="fs-4 fw-bold text-dark ps-6 py-5" colspan="3">Build Items</th>
														</tr>
													</thead>
													<tbody>
														<tr>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Gulp Build Tasks</h1>
										<!--end::Heading-->
										<!--begin::Notice-->
										<div class="py-5">
											<!--begin::Information-->
...
<code class="language-bash">gulp watch --demo1</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Localhost</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<p class="mb-0">Metronic uses
											<a href="https://www.npmjs.com/package/gulp-connect" target="_blank" class="fw-bolder me-1">Gulp-connect</a>plugin use to run a simple webserver for quick browsing the HTML templatest:</p>
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-bash">gulp localhost --demo1</code>
										...
										<div class="pt-5">
											...
											<code>http://localhost:8080/</code>. The default running port is
