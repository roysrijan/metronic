					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/rtl.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">RTL Version</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-5">
										...
										<a href="#rtl-version"></a>Quick Setup</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<p class="mb-0">Right to Left (RTL) version of Metronic can be easily setup with special Gulp and Webpack task that depends on
											<a href="https://yarnpkg.com/package/gulp-rtlcss" target="blank" class="fw-bolder">Gulp RTLCSS</a>&#160; and
											<a href="https://rtlcss.com/" class="fw-bolder">RTLCSS</a>&#160; tools.</p>
										</div>
										<!--end::Block-->
										<!--begin::List-->
										<ol class="py-5">
											<li class="py-3">Run gulp task with
											<code>--rtl</code>flag in
											<code>theme/tools/</code>folder to generate the RTL versions of CSS files.
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
...
<code class="language-bash">gulp --rtl --demo1</code>
												...
												<!--end::Highlight-->
											</div>For Webpack user, use below command.
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-bash">npm run build --rtl --demo1</code>
											...
											<li class="py-3">Switch CSS files to their RTL versions by adding
											<code>*.rtl.css</code>suffix to files that have RTL versions generated in assets folder:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-html">&lt;!--begin::Page Vendor Stylesheets(used by this page)--&gt;
...
&lt;!--end::Global Stylesheets Bundle--&gt;</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
											</div></li>
											<li class="py-3">Add the language direction attribute to the root HTML tag:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;html direction="rtl" dir="rtl" style="direction: rtl"&gt;</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
											</div></li>
											<li class="py-3">Plugins that come with their own RTL support can be skipped from the general RTL conversion by adding them into the skip list in the gulp config file as shown below:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-javascript">"compile": {
    "rtl": {
        "enabled": false,
        "skip": [
            "select2",
            ...
            "sweetalert2"
												...
												<!--end::Highlight-->
											</div>For more info about the gulp config file please check -
											<a href="../../demo1/dist/documentation/getting-started/build#gulp-build-options.html" class="fw-bolder" target="_blank">Gulp Build Options</a>.</li>
											<li class="py-3">Flip the KTMenu dropdown submenu alignment attributes as shown below:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">data-kt-menu-placement="bottom-start" =&gt; data-kt-menu-placement="bottom-end"
data-kt-menu-placement="right-start" =&gt; data-kt-menu-placement="left-start"</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-danger">
											...
											<!--end::Icon-->
											<!--begin::Description-->
											<div class="text-gray-700 fw-bold fs-6">Metronic provides basic RTL support using the mentioned automation tools and further adjustments of the theme and related 3rd-party plugins for the full RTL support are responsibiliy of buyers.</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
									</div>
