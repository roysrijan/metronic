					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/dark-mode.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Dark Mode</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
						...
						<div class="container" id="kt_docs_content_container">
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-5">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="dark-version">
										<a href="#dark-version"></a>Quick Setup</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<p class="mb-0">Metronic supports full
											<b>Dark Mode</b>&#160; that you can preview
											<a href="../../demo1/dist/index.html" class="fw-bold" target="_blank">here</a>&#160;and easiliy setup following the below instructions.</p>
										</div>
										<!--end::Block-->
										<!--begin::List-->
										<ol class="pt-5">
											<li class="py-3">Run gulp task with
											<code>--dark-mode</code>flag in
											<code>theme/tools/</code>folder to generate the Dark Mode of CSS files.
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
...
<code class="language-bash">gulp --dark-mode --demo1</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
											...
											<div class="py-5">
												...
												<div class="highlight">
													...
													<div class="highlight-code">
														<pre class="language-bash">
<code class="language-bash">npm run build --dark-mode --demo1</code>
</pre>
													</div>
												</div>
												<!--end::Highlight-->
											</div></li>
											<li class="py-3">Switch CSS files to their Dark Mode. For example
											<code>style.dark.bundle.css</code>and
											<code>plugins.dark.bundle.css</code>are generated in assets folder:
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
<code class="language-html">&lt;!--begin::Global Stylesheets Bundle(used by all pages)--&gt;
...
&lt;!--end::Global Stylesheets Bundle--&gt;</code>
											...
											<li class="py-3">Add
											<code>dark-mode</code>class name to the
											<code>&lt;body&gt;</code>tag. Keep other
											<code>body</code>class names.
											<div class="py-5">
												<!--begin::Highlight-->
												<div class="highlight">
													<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;body class="dark-mode ..."&gt;
&lt;!-- HTML content --&gt;
&lt;/body&gt;</code>
</pre>
													</div>
