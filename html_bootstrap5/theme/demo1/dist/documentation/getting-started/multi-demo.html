					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../../demo1/dist/documentation/getting-started/multi-demo.html">
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Multi-demo</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Metronic was specifically designed to support a multi-demo concept. This Multi-Demo concept is included within Metronic’s package files that also includes Metronic’s default global components and plugins.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pb-10">
										...
										<a href="#concep"></a>What is "Multi-Demo" concept?</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">A Multi-Demo means that by purchasing a single license of Metronic, you are entitled to receive and use all the different demo types that comes packed within Metronic itself. Each Demo within Metronic is uniquely designed for specific types of solutions or project requirement. For example, when you purchase Metronic, you’ll be able to utilize Metronic’s Default demo, a CRM Application demo, an Intranet System demo, an eCommerce Backend demo, a SAAS Service demo and so much more. Each Demo is organized within its own folder, which is also neatly packed with its own SCSS and JS files or any other files that are specifically required for that demo.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pb-10">
										...
										<a href="#components"></a>What is a "Global Component Component/Plugin" ?</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Global components or Global Plugins are abstract functional elements that can function independently within any of Metronic’s demos. For example, an invoice template or button styles are global components and a datatable or a form wizard are global plugins. Each demo is cross-compatible with Metronic’s default global components and plugins. This allows you to create and develop uniquely design projects by using different demo types together with hand-picked global components and plugins.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
									<!--begin::Section-->
									<div class="pb-0">
										...
										<a href="#customization"></a>Further Customization Options</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">All these options can also be overridden by your own customized component styles and settings to ensure that your projects with Metronic will always stay fresh and unique for each deployment. Please note that each deployment of Metronic will require a single regular license or higher.</div>
										<!--end::Block-->
									</div>
									<!--end::Section-->
								</div>
