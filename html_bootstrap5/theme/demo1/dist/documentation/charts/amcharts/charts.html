...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>AmCharts and Bootstrap Integration by Keenthemes</title>
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/charts/amcharts/charts.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">AmChart Charts</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pb-10">
										...
										<div class="py-5">
											...
											<a class="fw-bold" href="http://www.amcharts.com/demos/" target="_blank">AmCharts Home</a>.</div>
											<!--begin::Notice-->
											<!--begin::Information-->
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
												...
												<div class="text-gray-700 fw-bold fs-6">
													...
													<strong class="text-dark">AmChart</strong>. To find the promo code please check the README file in the purchased package.</div>
												</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
									...
									<div class="py-10">
										...
										<strong class="me-1">AmCharts</strong>in your page you will need to include</div>
										<!--end::Block-->
										<!--begin::Code-->
										<div class="py-5">
											<!--begin::Highlight-->
...
&lt;script src="https://cdn.amcharts.com/lib/4/themes/animated.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. Click on the legend items to show/hide series. A special method `arrangeColumns` is added to this demo which nicely aniamtes columns so that they would always be centered within the cell.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb01bbb" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb01bc3" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb01bbb" role="tabpanel">
														<div class="highlight-code">
            ...
            if (am4core.isNumber(delta)) {
                ...
                chart.series.each(function (series) {
                    ...
                    series.bulletsContainer.animate({ property: 'dx', to: dx }, series.interpolationDuration, series.interpolationEasing);
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb01bc3" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. This demo shows comparison of two line series from different periods.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb01fd4" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb01fda" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb01fd4" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    valueAxis.renderer.grid.template.strokeOpacity = 0.07;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb01fda" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
									...
									<div class="py-10">
										...
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. Each slice in pie series can have individual radius value, coming directly from data.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb022e6" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb022ef" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb022e6" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.legend = new am4charts.Legend();
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb022ef" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
									...
									<div class="py-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb02660" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb02665" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb02660" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    categoryAxis.cursorTooltipEnabled = false;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb02665" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;script src="https://cdn.amcharts.com/lib/4/plugins/bullets.js"&gt;&lt;/script&gt;</code>
</pre>
														</div>
													</div>
												</div>
									...
									<div class="pt-10">
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb02a4f" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb02a54" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb02a4f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.data = [
        ...
        },
        {
            ...
            'value': 2625
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb02a54" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code>
		...
		<script src="assets/js/custom/documentation/charts/amcharts/charts.js"></script>
