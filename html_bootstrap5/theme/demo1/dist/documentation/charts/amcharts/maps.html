...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>AmCharts Maps and Bootstrap Integration by Keenthemes</title>
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/charts/amcharts/maps.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb5de79" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb5de7f" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb5de79" role="tabpanel">
														<div class="highlight-code">
...
<code class="language-javascript">am4core.ready(function () {
    ...
    imageSeries.data = [{
        ...
        'color': colorSet.next()
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb5de7f" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
...
&lt;script src="https://cdn.amcharts.com/lib/4/geodata/worldLow.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#animated_map"></a>Animated Map</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e1b0" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e1b5" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb5e1b0" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    flyPlane();
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb5e1b5" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;script src="https://cdn.amcharts.com/lib/4/geodata/worldLow.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#rotating_map"></a>Rotating Map</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. With amCharts 4 you can create amazing Map charts and you don’t have to be limited to flattened representation of Earth. As you can see in this demo, you can use an orthographic projection to display the planet as an interactive globe.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e52b" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e530" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb5e52b" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
...
incidence per 1'000'000 total population.
    ...
    var data = {
        ...
        'ZW': 0.06
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb5e530" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;script src="https://cdn.amcharts.com/lib/4/geodata/continentsLow.js"&gt;&lt;/script&gt;</code>
									...
									<div class="pt-10">
										...
										<a href="#timezone_map"></a>Timezone Map</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e8c8" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eb5e8cc" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eb5e8c8" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    */
    ...
    polygonSeries.events.on('datavalidated', function () {
        labelSeries.data = polygonSeries.data;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eb5e8cc" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
