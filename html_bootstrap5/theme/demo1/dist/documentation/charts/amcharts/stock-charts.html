...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>AmCharts Stock and Bootstrap Integration by Keenthemes</title>
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/charts/amcharts/stock-charts.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">AmChart Stock Charts</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
...
&lt;script src="https://cdn.amcharts.com/lib/4/themes/animated.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-10">
										...
										<a href="#basic"></a>Basic Stock Chart</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eba22b8" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eba22be" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eba22b8" role="tabpanel">
														<div class="highlight-code">
...
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eba22be" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
...
&lt;script src="https://cdn.amcharts.com/lib/4/plugins/rangeSelector.js"&gt;&lt;/script&gt;</code>
</pre>
														</div>
													</div>
												</div>
									...
									<div class="py-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="compare">
										<a href="#compare"></a>Stock Comparison Chart</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eba25ad" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eba25b1" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eba25ad" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eba25b1" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;script src="https://cdn.amcharts.com/lib/4/plugins/rangeSelector.js"&gt;&lt;/script&gt;</code>
									...
									<div class="pt-10">
										<!--begin::Heading-->
										<h1 class="anchor fw-bolder mb-5" id="variance">
										<a href="#variance"></a>Variance indicators Chart</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. A clever use of highly configurable clustered Column series and adapters allows automatically-calculated variance indicators.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<!--begin::Card-->
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47eba28d2" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47eba28d6" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47eba28d2" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
													...
													<div class="tab-pane fade" id="kt_highlight_610d47eba28d6" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
