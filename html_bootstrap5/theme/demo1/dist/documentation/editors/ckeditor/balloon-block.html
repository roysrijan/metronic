							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/editors/ckeditor/balloon-block.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Balloon Block</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
										...
										<!--end::Icon-->
										<!--begin::Description-->
										<div class="text-gray-700 fw-bold fs-6 lh-lg">CKEditor is Modern JavaScript rich text editor with a modular architecture. Its clean UI and features provide the perfect WYSIWYG UX for creating semantic content.. For more info see
									...
									<div class="pt-10">
										...
										<a href="#basic" data-kt-scroll-toggle=""></a>Balloon Block CKEditor Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="mb-3">Here's how a balloon block CKEditor will look like. Click anywhere on the sample content below to trigger CKEditor. A small paragraph icon will appear on the left side of the content container. Click on that to open CKEditor's options.</div>
										</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="pt-5">
											...
											<figure class="image">
												<img src="assets/media/stock/600x400/img-1.jpg" alt="CKEditor Demo" />
										...
										<div class="py-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e96742e" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e967434" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e96742e" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">BalloonEditor
    ...
    .catch(error =&gt; {
        console.error(error);
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e967434" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;div id="kt_docs_ckeditor_balloon_block"&gt;
    &lt;h1&gt;Quick and simple CKEditor 5 Integration&lt;/h1&gt;
...
&lt;/div&gt;</code>
		...
		<script src="assets/js/custom/documentation/editors/ckeditor/balloon-block.js"></script>
