							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/editors/ckeditor/inline.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
									...
									<div class="d-flex align-items-center" id="kt_docs_header_title">
										...
										<div class="docs-page-title d-flex flex-column flex-lg-row align-items-lg-center py-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_docs_content_container', 'lg': '#kt_docs_header_title'}">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-6 my-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-dark">Inline</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-10">
										...
										<a href="#basic" data-kt-scroll-toggle=""></a>Inline CKEditor Example</h1>
										<!--end::Heading-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="mb-3">Here's how an inline CKEditor will look like. Click on the sample content below to trigger CKEditor.</div>
										</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e8b46cc" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e8b46d2" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e8b46cc" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">InlineEditor
    ...
    .catch(error =&gt; {
        console.error(error);
													...
													<div class="tab-pane fade" id="kt_highlight_610d47e8b46d2" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-html">
<code class="language-html">&lt;textarea name="kt_docs_ckeditor_inline" id="kt_docs_ckeditor_inline"&gt;
    &lt;h1&gt;Quick and simple CKEditor 5 Integration&lt;/h1&gt;
...
&lt;/textarea&gt;</code>
		...
		<script src="assets/js/custom/documentation/editors/ckeditor/inline.js"></script>
