							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../../demo1/dist/documentation/editors/tinymce/basic.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Basic</span>
							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
									...
									<div class="pt-10">
										...
										<!--begin::Block-->
										<div class="py-5">
											<div class="mb-3">Here's how a basic TinyMCE editor will look like.</div>
										</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
										...
										<div class="pt-5">
											...
											<div class="highlight">
												...
												<ul class="nav nav-pills" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_610d47e6ef5e1" role="tab">JAVASCRIPT</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_610d47e6ef5e8" role="tab">HTML</a>
													</li>
												</ul>
												<div class="tab-content">
													<div class="tab-pane fade show active" id="kt_highlight_610d47e6ef5e1" role="tabpanel">
														<div class="highlight-code">
															<pre class="language-javascript">
<code class="language-javascript">var options = {selector: "#kt_docs_tinymce_basic"};
...
tinymce.init(options);</code>
</pre>
														</div>
													</div>
													<div class="tab-pane fade" id="kt_highlight_610d47e6ef5e8" role="tabpanel">
														<div class="highlight-code">
...
&lt;/textarea&gt;</code>
		...
		<script src="assets/js/custom/documentation/editors/tinymce/basic.js"></script>
