      ...
      <div className='input-group input-group-solid mb-5'>
        <div className='input-group-prepend'>
          <span className='input-group-text'>
            <KTSVG className='svg-icon-4' path='/media/icons/duotone/General/Search.svg' />
          </span>
        </div>
        <input
          type='text'
        ...
        >
          <ul className='menu menu-custom menu-column menu-rounded menu-title-gray-600 menu-icon-muted menu-hover-bg-light-primary menu-active-bg-light-primary fw-bold'>
            <li className='menu-item py-1'>
              <a href='#' className='menu-link px-3'>
                <span className='menu-icon'>
                  <KTSVG className='svg-icon-1' path='/media/icons/duotone/Files/Media.svg' />
                </span>
            ...
            <li className='menu-item py-1'>
              <a href='#' className='menu-link px-3'>
                <span className='menu-icon'>
                  <KTSVG className='svg-icon-1' path='/media/icons/duotone/Design/Flatten.svg' />
                </span>
            ...
            <li className='menu-item py-1'>
              <a href='#' className='menu-link px-3'>
                <span className='menu-icon'>
                  <KTSVG className='svg-icon-1' path='/media/icons/duotone/Design/Saturation.svg' />
                </span>
