  ...
  return (
    <>
      <div className='pb-10'>
        ...
        <div className='py-5'>
          Use over 1000 high quality vector duotone SVG icons as image or inline SVG element in
      ...
      <div className='py-10'>
        ...
        <div className='py-5'>
          <div className='rounded border d-flex flex-wrap p-10'>
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Design/Adjust.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Code/Git3.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Communication/Chat2.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Design/Brush.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Design/Sketch.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Files/File-plus.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/General/Settings-2.svg')}
              className='h-40px me-10'
            />
            <img
              src={toAbsoluteUrl('/media/icons/duotone/Tools/Tools.svg')}
              className='h-40px me-10'
            />
            <img src={toAbsoluteUrl('/media/icons/duotone/Shopping/Chart-bar3.svg')} className='h-40px' />
          </div>
        </div>
      ...
      <div className='py-10'>
        ...
        <div className='py-5'>
          <div className='rounded border d-flex flex-wrap p-10'>
            <KTSVG
              path='/media/icons/duotone/Design/Adjust.svg'
              className='svg-icon svg-icon-3x me-10'
            />
            <KTSVG
              path='/media/icons/duotone/Code/Git3.svg'
              className='svg-icon svg-icon-3x me-10'
            />
            <KTSVG
            ...
            />
            <KTSVG
              path='/media/icons/duotone/Design/Sketch.svg'
              className='svg-icon svg-icon-3x me-10'
            />
            <KTSVG
...
/>
<img
  src={toAbsoluteUrl("/media/icons/duotone/Charts/Column-02-Down.svg")}
  className="h-40px"
/>
<img
...
/>
<img
  src={toAbsoluteUrl("/media/icons/duotone/Interface/Settings-01.svg")}
  className="h-40px"
/>
<img
