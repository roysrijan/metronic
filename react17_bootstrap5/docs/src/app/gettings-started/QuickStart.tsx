  ...
  return (
    <>
      ...
      <div className="d-flex align-items-center rounded py-5 px-5 bg-light-danger">
        <KTSVG path='/media/icons/duotone/Code/Info-circle.svg' className='svg-icon-3x svg-icon-danger me-5'/>
        <div className="text-gray-700 fw-bold fs-6">Warning: Use <b>LTS</b> version of <b>NodeJS</b>.
        </div>
      </div>
    </>
  )
