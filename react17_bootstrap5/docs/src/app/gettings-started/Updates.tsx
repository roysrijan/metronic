...
export function Updates() {
  ...
  return (
    <>
      ...
      <div className='py-4'>
        Like all HTML templates, you will need to manually handle all updates that we provide
        after purchase for free. The best practice is to always keep {REACT_APP_THEME_NAME}'s
        source folder on an entire separate folder within your project and then use{' '}
      ...
      <div className='pt-4'>
        ...
        <ol className='py-3'>
          ...
          <li className='py-2'>
            Unzip the latest version of {REACT_APP_THEME_NAME} and then browse through the
            elements (layout, widgets, plugins, etc) that you have used on your project.
          </li>
